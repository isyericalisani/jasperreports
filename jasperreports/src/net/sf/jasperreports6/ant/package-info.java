...
* definitions, based on the {@link net.sf.jasperreports6.ant.JRBaseAntTask JRBaseAntTask} class.
* <br/>
...
* <br/>
* This Ant task is implemented by the {@link net.sf.jasperreports6.ant.JRAntCompileTask JRAntCompileTask} class. Its syntax and behavior are 
...
* <li><code>compiler</code>: Name of the class that implements the {@link net.sf.jasperreports6.engine.design.JRCompiler JRCompiler} interface to be used for compiling the reports (optional).</li>
...
* provides becomes very handy. It is implemented by the {@link net.sf.jasperreports6.ant.JRAntDecompileTask JRAntDecompileTask} class and its declaration inside a 
...
* the {@link net.sf.jasperreports6.engine.xml.JRXmlLoader JRXmlLoader} or {@link net.sf.jasperreports6.engine.util.JRLoader JRLoader} 
* and the {@link net.sf.jasperreports6.engine.xml.JRXmlWriter JRXmlWriter}. 
* <br/>
...
* {@link net.sf.jasperreports6.ant.JRAntUpdateTask JRAntUpdateTask} class, which should have the 
...
* 
*/
package net.sf.jasperreports6.ant;