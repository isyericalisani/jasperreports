...
import net.sf.jasperreports6.engine.JRDataSource;
...
import net.sf.jasperreports6.olap.mapping.AxisPosition;
import net.sf.jasperreports6.olap.mapping.DataMapping;
import net.sf.jasperreports6.olap.mapping.Mapping;
import net.sf.jasperreports6.olap.mapping.MappingLexer;
import net.sf.jasperreports6.olap.mapping.MappingMetadata;
import net.sf.jasperreports6.olap.mapping.MappingParser;
import net.sf.jasperreports6.olap.mapping.Member;
import net.sf.jasperreports6.olap.mapping.MemberDepth;
import net.sf.jasperreports6.olap.mapping.MemberMapping;
import net.sf.jasperreports6.olap.mapping.MemberProperty;
import net.sf.jasperreports6.olap.mapping.Tuple;
import net.sf.jasperreports6.olap.mapping.TuplePosition;
import net.sf.jasperreports6.olap.result.JROlapCell;
import net.sf.jasperreports6.olap.result.JROlapHierarchy;
import net.sf.jasperreports6.olap.result.JROlapHierarchyLevel;
import net.sf.jasperreports6.olap.result.JROlapMember;
import net.sf.jasperreports6.olap.result.JROlapMemberTuple;
import net.sf.jasperreports6.olap.result.JROlapResult;
import net.sf.jasperreports6.olap.result.JROlapResultAxis;
...
public class JROlapDataSource implements JRDataSource, MappingMetadata
{
	...
	protected void processMemberInfo(net.sf.jasperreports6.olap.mapping.Member member)
	{
	...
	@Override
	public int getDimensionIndex(net.sf.jasperreports6.olap.mapping.Axis axis, String dimension)
	{
	...
	protected void setMatchMemberDepth(net.sf.jasperreports6.olap.mapping.Member memberInfo, JROlapMember member)
	{
	...
	protected abstract class FieldMatcher
	{
		...
		public final JROlapMember member(net.sf.jasperreports6.olap.mapping.Member memberInfo, int[] positions)
		{
	...
	{
		final net.sf.jasperreports6.olap.mapping.Member memberInfo;
	...
	protected class DataFieldMatcher extends FieldMatcher
	{
		...
		private final net.sf.jasperreports6.olap.mapping.Member[] members;
