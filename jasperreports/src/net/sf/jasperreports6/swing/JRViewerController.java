 ...
 */
package net.sf.jasperreports6.swing;
...
import net.sf.jasperreports6.engine.xml.JRPrintXmlLoader;
...
public class JRViewerController
{
	 ...
	 */
	private net.sf.jasperreports6.engine.util.LocalJasperReportsContext localJasperReportsContext;
	...
	public void loadReport(String fileName, boolean isXmlReport) throws JRException
	{
		...
		net.sf.jasperreports6.engine.util.SimpleFileResolver fileResolver = 
			new net.sf.jasperreports6.engine.util.SimpleFileResolver(Arrays.asList(new File[]{new File(fileName).getParentFile(), new File(".")}));
		fileResolver.setResolveAbsolutePath(true);
		if (localJasperReportsContext == null)
		{
			localJasperReportsContext = new net.sf.jasperreports6.engine.util.LocalJasperReportsContext(jasperReportsContext);
