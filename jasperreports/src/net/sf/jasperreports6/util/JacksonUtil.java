...
public class JacksonUtil
{
	...
	public ObjectMapper getObjectMapper()
	{
		...
		if (mapper == null)
		{
			...
			List<net.sf.jasperreports6.web.util.JacksonMapping> depJacksonMappings = 
				jasperReportsContext.getExtensions(net.sf.jasperreports6.web.util.JacksonMapping.class);
