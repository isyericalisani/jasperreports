 ...
 */
package net.sf.jasperreports6.properties;
...
import net.sf.jasperreports6.data.DataAdapter;
import net.sf.jasperreports6.data.DataAdapterService;
import net.sf.jasperreports6.data.DataAdapterServiceUtil;
import net.sf.jasperreports6.data.DataFile;
import net.sf.jasperreports6.data.DataFileServiceFactory;
import net.sf.jasperreports6.data.FileDataAdapter;
...
import net.sf.jasperreports6.engine.util.Designator;
