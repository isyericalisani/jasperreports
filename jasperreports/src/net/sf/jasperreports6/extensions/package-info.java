 ...
 * {@link net.sf.jasperreports6.extensions.ExtensionsRegistryFactory} 
 * interface. It produces instances of the 
 * {@link net.sf.jasperreports6.extensions.ExtensionsRegistry} interface, 
 ...
 * </p><p>
 * {@link net.sf.jasperreports6.extensions.ExtensionsRegistryFactory#createRegistry(String, JRPropertiesMap) createRegistry(String, JRPropertiesMap)}
 * </p><p>
 ...
 * is represented by the {@link net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle} 
 ...
 * interface for them is the {@link net.sf.jasperreports6.charts.ChartThemeBundle} interface. 
 ...
 * {@link net.sf.jasperreports6.engine.export.JRHyperlinkProducerFactory} interface 
 ...
 * {@link net.sf.jasperreports6.extensions.SpringExtensionsRegistryFactory} class 
 * and works by loading a Spring beans XML file and using beans of specific types as 
 * extensions. 
 * </p><p>
 * The factory requires a property named 
 * {@link net.sf.jasperreports6.extensions.DefaultExtensionsRegistry#PROPERTY_REGISTRY_PREFIX net.sf.jasperreports.extension.&lt;registry_id&gt;.spring.beans.resource} to 
 * be present in the properties map passed to the 
 * </p><p>
 * <code>{@link net.sf.jasperreports6.extensions.ExtensionsRegistryFactory#createRegistry(String, JRPropertiesMap) createRegistry(String, JRPropertiesMap)}</code>
 * </p><p>
 ...
 * {@link net.sf.jasperreports6.extensions.SpringExtensionsRegistry} instance which 
