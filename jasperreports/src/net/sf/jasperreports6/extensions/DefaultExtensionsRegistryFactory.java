 ...
 */
package net.sf.jasperreports6.extensions;

import java.util.Collections;
import java.util.List;

import net.sf.jasperreports6.charts.ChartThemeBundle;
import net.sf.jasperreports6.components.headertoolbar.HeaderToolbarElement;
import net.sf.jasperreports6.components.headertoolbar.json.HeaderToolbarElementJsonHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElement;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementCsvHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementDocxHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementGraphics2DHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementHtmlHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementOdsHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementOdtHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementPdfHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementPptxHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementRtfHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementXlsHandler;
import net.sf.jasperreports6.components.iconlabel.IconLabelElementXlsxHandler;
import net.sf.jasperreports6.components.map.MapComponent;
import net.sf.jasperreports6.components.map.MapElementDocxHandler;
import net.sf.jasperreports6.components.map.MapElementGraphics2DHandler;
import net.sf.jasperreports6.components.map.MapElementHtmlHandler;
import net.sf.jasperreports6.components.map.MapElementJsonHandler;
import net.sf.jasperreports6.components.map.MapElementOdsHandler;
import net.sf.jasperreports6.components.map.MapElementOdtHandler;
import net.sf.jasperreports6.components.map.MapElementPdfHandler;
import net.sf.jasperreports6.components.map.MapElementPptxHandler;
import net.sf.jasperreports6.components.map.MapElementRtfHandler;
import net.sf.jasperreports6.components.map.MapElementXlsHandler;
import net.sf.jasperreports6.components.map.MapElementXlsxHandler;
import net.sf.jasperreports6.components.sort.SortElement;
import net.sf.jasperreports6.components.sort.SortElementHtmlHandler;
import net.sf.jasperreports6.components.sort.SortElementJsonHandler;
import net.sf.jasperreports6.crosstabs.interactive.CrosstabInteractiveJsonHandler;
import net.sf.jasperreports6.engine.JRPropertiesMap;
import net.sf.jasperreports6.engine.export.GenericElementHandler;
import net.sf.jasperreports6.engine.export.GenericElementHandlerBundle;
import net.sf.jasperreports6.engine.export.HtmlExporter;
import net.sf.jasperreports6.engine.export.JRCsvExporter;
import net.sf.jasperreports6.engine.export.JRGraphics2DExporter;
import net.sf.jasperreports6.engine.export.JRPdfExporter;
import net.sf.jasperreports6.engine.export.JRRtfExporter;
import net.sf.jasperreports6.engine.export.JRXlsExporter;
import net.sf.jasperreports6.engine.export.JsonExporter;
import net.sf.jasperreports6.engine.export.oasis.JROdsExporter;
import net.sf.jasperreports6.engine.export.oasis.JROdtExporter;
import net.sf.jasperreports6.engine.export.ooxml.JRDocxExporter;
import net.sf.jasperreports6.engine.export.ooxml.JRPptxExporter;
import net.sf.jasperreports6.engine.export.ooxml.JRXlsxExporter;
import net.sf.jasperreports6.engine.fill.DefaultChartTheme;
import net.sf.jasperreports6.engine.fill.JRFillCrosstab;
import net.sf.jasperreports6.engine.query.DefaultQueryExecuterFactoryBundle;
import net.sf.jasperreports6.engine.query.JRQueryExecuterFactoryBundle;
import net.sf.jasperreports6.engine.scriptlets.DefaultScriptletFactory;
import net.sf.jasperreports6.engine.scriptlets.ScriptletFactory;
import net.sf.jasperreports6.engine.util.MessageProviderFactory;
import net.sf.jasperreports6.engine.util.ResourceBundleMessageProviderFactory;
...
public class DefaultExtensionsRegistryFactory implements ExtensionsRegistryFactory
{
	private static final GenericElementHandlerBundle HANDLER_BUNDLE = 
		new GenericElementHandlerBundle()
		{
			...
			{
				if (
					net.sf.jasperreports6.engine.export.FlashPrintElement.FLASH_ELEMENT_NAME.equals(elementName) 
					&& HtmlExporter.HTML_EXPORTER_KEY.equals(exporterKey)
					)
				{
					return net.sf.jasperreports6.engine.export.FlashHtmlHandler.getInstance();
				}
