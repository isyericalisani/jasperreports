...
import net.sf.jasperreports6.data.AbstractDataAdapter;
import net.sf.jasperreports6.data.DataFile;
import net.sf.jasperreports6.data.RepositoryDataLocation;
import net.sf.jasperreports6.data.StandardRepositoryDataLocation;
...
public class JsonDataAdapterImpl extends AbstractDataAdapter implements
	...
	/**
	 * @deprecated replaced by {@link #setDataFile(net.sf.jasperreports6.data.DataFile)} and {@link StandardRepositoryDataLocation}
	 */
	@Override
	@Deprecated
