 ...
 */
package net.sf.jasperreports6.data.xlsx;

import java.io.InputStream;
import java.util.Map;

import net.sf.jasperreports6.data.excel.ExcelFormatEnum;
import net.sf.jasperreports6.data.xls.AbstractXlsDataAdapterService;
...
import net.sf.jasperreports6.engine.data.AbstractXlsDataSource;
import net.sf.jasperreports6.engine.query.ExcelQueryExecuter;
import net.sf.jasperreports6.engine.query.ExcelQueryExecuterFactory;
