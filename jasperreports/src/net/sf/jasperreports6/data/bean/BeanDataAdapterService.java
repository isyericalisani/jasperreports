 ...
 */
package net.sf.jasperreports6.data.bean;
...
import net.sf.jasperreports6.data.AbstractClasspathAwareDataAdapterService;
...
import net.sf.jasperreports6.engine.data.JRAbstractBeanDataSource;
import net.sf.jasperreports6.engine.data.JRBeanArrayDataSource;
import net.sf.jasperreports6.engine.data.JRBeanCollectionDataSource;
