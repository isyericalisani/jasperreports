 ...
 */
package net.sf.jasperreports6.data.xml;
...
import net.sf.jasperreports6.engine.query.JRXPathQueryExecuterFactory;
...
public class XmlDataAdapterService extends AbstractDataAdapterService implements Designated
{
	...
	public static final String SERVICE_DESIGNATION = "net.sf.jasperreports6.data.adapter:XML";
