...
import net.sf.jasperreports6.components.table.StandardBaseColumn;
...
import net.sf.jasperreports6.web.commands.Command;
import net.sf.jasperreports6.web.commands.CommandException;
import net.sf.jasperreports6.web.commands.CommandStack;
