 ...
 */
package net.sf.jasperreports6.components.headertoolbar.json;
...
import net.sf.jasperreports6.components.headertoolbar.actions.ConditionalFormattingData;
import net.sf.jasperreports6.components.headertoolbar.actions.EditTextElementData;
import net.sf.jasperreports6.components.headertoolbar.actions.FilterAction;
import net.sf.jasperreports6.components.headertoolbar.actions.SortAction;
import net.sf.jasperreports6.components.sort.FieldFilter;
import net.sf.jasperreports6.components.sort.FilterTypeBooleanOperatorsEnum;
import net.sf.jasperreports6.components.sort.FilterTypeDateOperatorsEnum;
import net.sf.jasperreports6.components.sort.FilterTypeNumericOperatorsEnum;
import net.sf.jasperreports6.components.sort.FilterTypeTextOperatorsEnum;
...
import net.sf.jasperreports6.components.sort.actions.FilterData;
import net.sf.jasperreports6.components.sort.actions.SortData;
...
import net.sf.jasperreports6.components.table.GroupCell;
import net.sf.jasperreports6.components.table.StandardColumn;
import net.sf.jasperreports6.components.table.StandardTable;
...
import net.sf.jasperreports6.engine.JRIdentifiable;
...
import net.sf.jasperreports6.engine.design.JRDesignDatasetRun;
import net.sf.jasperreports6.engine.design.JRDesignTextElement;
import net.sf.jasperreports6.engine.design.JRDesignTextField;
import net.sf.jasperreports6.engine.design.JasperDesign;
import net.sf.jasperreports6.engine.export.GenericElementJsonHandler;
import net.sf.jasperreports6.engine.export.JsonExporterContext;
...
import net.sf.jasperreports6.repo.JasperDesignCache;
import net.sf.jasperreports6.util.JacksonUtil;
import net.sf.jasperreports6.web.commands.CommandTarget;
import net.sf.jasperreports6.web.util.VelocityUtil;
...
public class HeaderToolbarElementJsonHandler implements GenericElementJsonHandler
{
	...
	private static final String HEADER_TOOLBAR_ELEMENT_JSON_TEMPLATE = "net/sf/jasperreports6/components/headertoolbar/json/resources/HeaderToolbarElementJsonTemplate.vm";
	private static final String PARAM_GENERATED_TEMPLATE_PREFIX = "net.sf.jasperreports6.headertoolbar.";
