...
import net.sf.jasperreports6.components.barbecue.BarbecueCompiler;
import net.sf.jasperreports6.components.barbecue.BarbecueDesignConverter;
import net.sf.jasperreports6.components.barbecue.BarbecueFillFactory;
import net.sf.jasperreports6.components.barcode4j.BarcodeCompiler;
import net.sf.jasperreports6.components.barcode4j.BarcodeDesignConverter;
import net.sf.jasperreports6.components.barcode4j.BarcodeFillFactory;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentCompiler;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentDesignConverter;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentFillFactory;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentManager;
import net.sf.jasperreports6.components.list.FillListFactory;
import net.sf.jasperreports6.components.list.ListComponent;
import net.sf.jasperreports6.components.list.ListComponentCompiler;
import net.sf.jasperreports6.components.list.ListDesignConverter;
import net.sf.jasperreports6.components.map.MapCompiler;
import net.sf.jasperreports6.components.map.MapDesignConverter;
import net.sf.jasperreports6.components.map.fill.MapFillFactory;
import net.sf.jasperreports6.components.sort.SortComponentCompiler;
import net.sf.jasperreports6.components.sort.SortComponentDesignConverter;
import net.sf.jasperreports6.components.sort.SortComponentFillFactory;
import net.sf.jasperreports6.components.spiderchart.SpiderChartCompiler;
import net.sf.jasperreports6.components.spiderchart.SpiderChartDesignConverter;
import net.sf.jasperreports6.components.spiderchart.SpiderChartFillFactory;
import net.sf.jasperreports6.components.table.FillTableFactory;
import net.sf.jasperreports6.components.table.TableCompiler;
import net.sf.jasperreports6.components.table.TableDesignConverter;
import net.sf.jasperreports6.engine.JRPropertiesMap;
import net.sf.jasperreports6.engine.component.ComponentManager;
import net.sf.jasperreports6.engine.component.ComponentsBundle;
import net.sf.jasperreports6.engine.component.DefaultComponentXmlParser;
import net.sf.jasperreports6.engine.component.DefaultComponentsBundle;
import net.sf.jasperreports6.extensions.ExtensionsRegistry;
import net.sf.jasperreports6.extensions.ExtensionsRegistryFactory;
import net.sf.jasperreports6.extensions.ListExtensionsRegistry;
