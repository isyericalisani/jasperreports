 ...
 */
package net.sf.jasperreports6.components;

import org.apache.commons.digester.Digester;

import net.sf.jasperreports6.components.barbecue.StandardBarbecueComponent;
import net.sf.jasperreports6.components.barcode4j.CodabarComponent;
import net.sf.jasperreports6.components.barcode4j.Code128Component;
import net.sf.jasperreports6.components.barcode4j.Code39Component;
import net.sf.jasperreports6.components.barcode4j.DataMatrixComponent;
import net.sf.jasperreports6.components.barcode4j.EAN128Component;
import net.sf.jasperreports6.components.barcode4j.EAN13Component;
import net.sf.jasperreports6.components.barcode4j.EAN8Component;
import net.sf.jasperreports6.components.barcode4j.ErrorCorrectionLevelEnum;
import net.sf.jasperreports6.components.barcode4j.Interleaved2Of5Component;
import net.sf.jasperreports6.components.barcode4j.OrientationRule;
import net.sf.jasperreports6.components.barcode4j.PDF417Component;
import net.sf.jasperreports6.components.barcode4j.POSTNETComponent;
import net.sf.jasperreports6.components.barcode4j.QRCodeComponent;
import net.sf.jasperreports6.components.barcode4j.RoyalMailCustomerComponent;
import net.sf.jasperreports6.components.barcode4j.TextPositionEnum;
import net.sf.jasperreports6.components.barcode4j.UPCAComponent;
import net.sf.jasperreports6.components.barcode4j.UPCEComponent;
import net.sf.jasperreports6.components.barcode4j.USPSIntelligentMailComponent;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentDigester;
import net.sf.jasperreports6.components.items.Item;
import net.sf.jasperreports6.components.items.ItemData;
import net.sf.jasperreports6.components.items.ItemDataXmlFactory;
import net.sf.jasperreports6.components.items.ItemDatasetFactory;
import net.sf.jasperreports6.components.items.ItemProperty;
import net.sf.jasperreports6.components.items.ItemPropertyXmlFactory;
import net.sf.jasperreports6.components.items.ItemXmlFactory;
import net.sf.jasperreports6.components.list.DesignListContents;
import net.sf.jasperreports6.components.list.ListComponent;
import net.sf.jasperreports6.components.list.StandardListComponent;
import net.sf.jasperreports6.components.map.MapXmlFactory;
import net.sf.jasperreports6.components.map.MarkerItemData;
import net.sf.jasperreports6.components.map.MarkerItemDataXmlFactory;
import net.sf.jasperreports6.components.sort.SortComponentDigester;
import net.sf.jasperreports6.components.spiderchart.SpiderChartDigester;
import net.sf.jasperreports6.components.table.DesignBaseCell;
import net.sf.jasperreports6.components.table.DesignCell;
import net.sf.jasperreports6.components.table.StandardColumn;
import net.sf.jasperreports6.components.table.StandardColumnGroup;
import net.sf.jasperreports6.components.table.StandardGroupCell;
import net.sf.jasperreports6.components.table.StandardGroupRow;
import net.sf.jasperreports6.components.table.StandardRow;
import net.sf.jasperreports6.components.table.StandardTableFactory;
import net.sf.jasperreports6.components.table.TableComponent;
...
import net.sf.jasperreports6.engine.type.SplitTypeEnum;
import net.sf.jasperreports6.engine.xml.DatasetRunReportContextRule;
import net.sf.jasperreports6.engine.xml.JRExpressionFactory;
import net.sf.jasperreports6.engine.xml.JRXmlConstants;
import net.sf.jasperreports6.engine.xml.JRXmlWriter;
import net.sf.jasperreports6.engine.xml.StyleContainerRule;
import net.sf.jasperreports6.engine.xml.UuidPropertyRule;
...
public class ComponentsXmlDigesterConfigurer implements XmlDigesterConfigurer
{
	...
	protected void addMapRules(Digester digester)
	{
		...
		digester.addFactoryCreate(markerDatasetPattern, net.sf.jasperreports6.components.map.MarkerDatasetXmlFactory.class.getName());
		digester.addSetNext(markerDatasetPattern, "setMarkerDataset", net.sf.jasperreports6.components.map.MarkerDataset.class.getName());

		String markerPattern = markerDatasetPattern + "/marker";
		digester.addFactoryCreate(markerPattern, net.sf.jasperreports6.components.map.MarkerXmlFactory.class.getName());
		digester.addSetNext(markerPattern, "addMarker", net.sf.jasperreports6.components.map.Marker.class.getName());

		String markerPropertyPattern = markerPattern + "/markerProperty";
		digester.addFactoryCreate(markerPropertyPattern, net.sf.jasperreports6.components.map.MarkerPropertyXmlFactory.class.getName());
		digester.addSetNext(markerPropertyPattern, "addMarkerProperty", net.sf.jasperreports6.components.map.MarkerProperty.class.getName());
