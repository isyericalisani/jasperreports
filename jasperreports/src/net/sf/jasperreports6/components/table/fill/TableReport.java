 ...
 */
package net.sf.jasperreports6.components.table.fill;
...
import net.sf.jasperreports6.components.ComponentsExtensionsRegistryFactory;
import net.sf.jasperreports6.components.headertoolbar.HeaderToolbarElement;
import net.sf.jasperreports6.components.headertoolbar.HeaderToolbarElementUtils;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponent;
import net.sf.jasperreports6.components.iconlabel.IconLabelComponentUtil;
import net.sf.jasperreports6.components.sort.FieldFilter;
import net.sf.jasperreports6.components.sort.FilterTypesEnum;
...
import net.sf.jasperreports6.components.table.BaseCell;
import net.sf.jasperreports6.components.table.BaseColumn;
import net.sf.jasperreports6.components.table.Cell;
import net.sf.jasperreports6.components.table.Column;
import net.sf.jasperreports6.components.table.ColumnGroup;
import net.sf.jasperreports6.components.table.ColumnVisitor;
import net.sf.jasperreports6.components.table.Row;
import net.sf.jasperreports6.components.table.TableComponent;
import net.sf.jasperreports6.components.table.WhenNoDataTypeTableEnum;
import net.sf.jasperreports6.components.table.util.TableUtil;
...
import net.sf.jasperreports6.engine.JRChild;
...
import net.sf.jasperreports6.engine.JRReport;
...
import net.sf.jasperreports6.engine.base.JRBaseElement;
import net.sf.jasperreports6.engine.base.JRBaseTextElement;
import net.sf.jasperreports6.engine.component.FillContext;
import net.sf.jasperreports6.engine.design.JRDesignBand;
...
import net.sf.jasperreports6.engine.design.JRDesignFrame;
import net.sf.jasperreports6.engine.design.JRDesignGenericElement;
import net.sf.jasperreports6.engine.design.JRDesignGenericElementParameter;
import net.sf.jasperreports6.engine.design.JRDesignGroup;
import net.sf.jasperreports6.engine.design.JRDesignSection;
import net.sf.jasperreports6.engine.design.JRDesignTextField;
import net.sf.jasperreports6.engine.export.HtmlExporter;
import net.sf.jasperreports6.engine.export.JRPdfExporterTagHelper;
import net.sf.jasperreports6.engine.export.MatcherExporterFilter;
import net.sf.jasperreports6.engine.fill.BuiltinExpressionEvaluator;
import net.sf.jasperreports6.engine.fill.BuiltinExpressionEvaluatorFactory;
import net.sf.jasperreports6.engine.fill.DatasetExpressionEvaluator;
import net.sf.jasperreports6.engine.fill.JRExpressionEvalException;
import net.sf.jasperreports6.engine.fill.JRFillField;
import net.sf.jasperreports6.engine.fill.JRFillParameter;
import net.sf.jasperreports6.engine.fill.JRFillVariable;
...
import net.sf.jasperreports6.engine.type.SectionTypeEnum;
...
import net.sf.jasperreports6.engine.util.StyleUtil;
	...
	protected class ColumnHeaderCreator extends ReportBandCreator
	{
		...
		protected void addHeaderToolbarElement(Column column, JRDesignFrame frame, JRTextField sortTextField)
		{
			...
			if (sortTextField != null && interactiveColumn)
			{
				...
				genericElement.setPositionType(net.sf.jasperreports6.engine.type.PositionTypeEnum.FIX_RELATIVE_TO_TOP);
