...
public interface MapComponent extends Component, JRCloneable
{
	...
	/**
	 * Legend or resetMap item property with value of type {@link net.sf.jasperreports6.components.map.fill.CustomMapControlPositionEnum CustomMapControlPositionEnum}
	 * <p/>
	 * For {@link #ELEMENT_LEGEND_ITEM legendItem} it defaults to {@link net.sf.jasperreports6.components.map.fill.CustomMapControlPositionEnum#RIGHT_CENTER CustomMapControlPositionEnum.RIGHT_CENTER}
	 * <br/>
	 * For {@link #ELEMENT_RESET_MAP_ITEM resetMapItem} it defaults to {@link net.sf.jasperreports6.components.map.fill.CustomMapControlPositionEnum#RIGHT_TOP CustomMapControlPositionEnum.RIGHT_TOP}
	 */
	...
	// legend properties
	/**
	 * Legend item property with value of type {@link net.sf.jasperreports6.components.map.fill.CustomMapControlOrientationEnum CustomMapControlOrientationEnum}
	 * <p/>
	 * Defaults to {@link net.sf.jasperreports6.components.map.fill.CustomMapControlOrientationEnum#VERTICAL VERTICAL}
	 */
	...
	/**
	 * Returns a {@link net.sf.jasperreports6.engine.JRExpression JRExpression} 
	 ...
	 * <ul>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapTypeEnum#ROADMAP ROADMAP} (default value)</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapTypeEnum#SATELLITE SATELLITE}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapTypeEnum#TERRAIN TERRAIN}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapTypeEnum#HYBRID HYBRID}</li>
	 * </ul>
	 * @return the type of the Google map
	 * @see net.sf.jasperreports6.components.map.type.MapTypeEnum
	 */
	 ...
	 * <ul>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#PNG PNG} (default value)</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#PNG_8 PNG_8}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#PNG_32 PNG_32}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#GIF GIF}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#JPG JPG}</li>
	 * <li>{@link net.sf.jasperreports6.components.map.type.MapImageTypeEnum#JPG_BASELINE JPG_BASELINE}</li>
	 * </ul>
	 * @return the image format of the map
	 * @see net.sf.jasperreports6.components.map.type.MapImageTypeEnum
	 */
	 ...
	 * <ul>
	 * <li>{@link net.sf.jasperreports6.engine.type.OnErrorTypeEnum#ERROR ERROR} (default value)</li>
	 * <li>{@link net.sf.jasperreports6.engine.type.OnErrorTypeEnum#BLANK BLANK}</li>
	 * <li>{@link net.sf.jasperreports6.engine.type.OnErrorTypeEnum#ICON ICON}</li>
	 * </ul>
	 * @return the onErrorType attribute
	 * @see net.sf.jasperreports6.engine.type.OnErrorTypeEnum
	 */
