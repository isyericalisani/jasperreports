 ...
 * @deprecated Replaced by {@link net.sf.jasperreports6.components.items.ItemProperty}.
 */
public interface ItemProperty extends JRCloneable
{
	...
	/**
	 * Returns a {@link net.sf.jasperreports6.engine.JRExpression JRExpression} representing 
