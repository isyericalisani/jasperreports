...
import net.sf.jasperreports6.components.barbecue.BarbecueComponent;
import net.sf.jasperreports6.components.barcode4j.BarcodeComponent;
import net.sf.jasperreports6.components.barcode4j.BarcodeXmlWriter;
...
import net.sf.jasperreports6.components.list.ListContents;
...
import net.sf.jasperreports6.components.map.type.MapImageTypeEnum;
import net.sf.jasperreports6.components.map.type.MapScaleEnum;
import net.sf.jasperreports6.components.map.type.MapTypeEnum;
import net.sf.jasperreports6.components.sort.SortComponent;
import net.sf.jasperreports6.components.sort.SortComponentXmlWriter;
import net.sf.jasperreports6.components.spiderchart.SpiderChartComponent;
import net.sf.jasperreports6.components.spiderchart.SpiderChartXmlWriter;
...
import net.sf.jasperreports6.components.table.GroupRow;
...
public class ComponentsXmlWriter extends AbstractComponentXmlWriter
{
	...
	protected void writeMap(JRComponentElement componentElement, JRXmlWriter reportWriter) throws IOException
	{
		...
		if(isNewerVersionOrEqual(componentElement, reportWriter, JRConstants.VERSION_6_20_2)) {
			...
			@SuppressWarnings("deprecation")
			net.sf.jasperreports6.components.map.MarkerDataset dataset = map.getMarkerDataset();
	 ...
	 */
	private void writeMarkerDataset(net.sf.jasperreports6.components.map.MarkerDataset dataset, JRXmlWriteHelper writer, JRXmlWriter reportWriter, XmlNamespace namespace, JRComponentElement componentElement) throws IOException
	{
		if (dataset != null)
		{
			...
			/*   */
			List<net.sf.jasperreports6.components.map.Marker> markerList = dataset.getMarkers();
			if (markerList != null && !markerList.isEmpty())
			{
				for(net.sf.jasperreports6.components.map.Marker marker : markerList)
				{
	...
	private void writeMarker(
		net.sf.jasperreports6.components.map.Marker marker, 
		...
		) throws IOException
	{
		...
		List<net.sf.jasperreports6.components.map.MarkerProperty> markerProperties = marker.getProperties();
		for(net.sf.jasperreports6.components.map.MarkerProperty property : markerProperties)
		{
	...
	private void writeMarkerProperty(
		net.sf.jasperreports6.components.map.MarkerProperty markerProperty, 
		JRXmlWriteHelper writer, 
		JRXmlWriter reportWriter, 
		XmlNamespace namespace, 
		JRComponentElement componentElement
