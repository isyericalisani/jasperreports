...
import net.sf.jasperreports6.engine.component.BaseComponentContext;
import net.sf.jasperreports6.engine.component.ComponentContext;
import net.sf.jasperreports6.engine.component.ContextAwareComponent;
...
public class IconLabelComponent implements ContextAwareComponent, JRBoxContainer, JRImageAlignment, Serializable, JRChangeEventsSupport 
{
	 ...
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.HorizontalAlignEnum horizontalAlign;
	/**
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.VerticalAlignEnum verticalAlign;
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		{
			horizontalImageAlign = net.sf.jasperreports6.engine.type.HorizontalAlignEnum.getHorizontalImageAlignEnum(horizontalAlign);
			verticalImageAlign = net.sf.jasperreports6.engine.type.VerticalAlignEnum.getVerticalImageAlignEnum(verticalAlign);
