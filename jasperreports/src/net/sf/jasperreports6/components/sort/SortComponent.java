...
public class SortComponent implements ContextAwareComponent, Serializable, JRChangeEventsSupport {
	 ...
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.VerticalAlignEnum handlerVerticalAlign;
	/**
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.HorizontalAlignEnum handlerHorizontalAlign;
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		{
			handlerHorizontalImageAlign = net.sf.jasperreports6.engine.type.HorizontalAlignEnum.getHorizontalImageAlignEnum(handlerHorizontalAlign);
			handlerVerticalImageAlign = net.sf.jasperreports6.engine.type.VerticalAlignEnum.getVerticalImageAlignEnum(handlerVerticalAlign);
