 ...
 * be viewed or printed. The {@link net.sf.jasperreports6.swing.JRViewer} class represents 
 ...
 * {@link net.sf.jasperreports6.view.JasperViewer} class and is used in almost all the 
 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.view.JasperViewer} - use this class to view generated reports, 
 * either as in-memory objects or serialized objects on disk or even stored in XML format.</li>
 * <li>{@link net.sf.jasperreports6.view.JasperDesignViewer} - use this class to preview report templates, 
 ...
 * {@link net.sf.jasperreports6.swing.JRViewer} class and its companions. It is in fact a 
 ...
 * {@link net.sf.jasperreports6.view.JRHyperlinkListener} interface and add an instance 
 * of this listener class to register with the viewer component, using the 
 * {@link net.sf.jasperreports6.swing.JRViewerPanel#addHyperlinkListener(JRHyperlinkListener) addHyperlinkListener(JRHyperlinkListener)} method exposed by the 
 * {@link net.sf.jasperreports6.swing.JRViewerPanel} class. By doing this, you ensure that the 
 * viewer will also call the implementation of the 
 * {@link net.sf.jasperreports6.swing.JRViewerPanel#gotoHyperlink(net.sf.jasperreports.engine.JRPrintHyperlink) gotoHyperlink(JRPrintHyperlink)} method in which 
 ...
 * {@link net.sf.jasperreports6.swing.JRViewer#VIEWER_RENDER_BUFFER_MAX_SIZE net.sf.jasperreports.viewer.render.buffer.max.size} configuration property. 
 * The value of this property represents the maximum size (in pixels) of a buffered image 
 * that would be used by the {@link net.sf.jasperreports6.swing.JRViewer} component to render 
 ...
 * 
 * @see net.sf.jasperreports6.view.JRHyperlinkListener
 */
package net.sf.jasperreports6.view;
