...
public class JasperDesignViewer extends javax.swing.JFrame 
{
		...
		)  throws JRException
	{
		...
		net.sf.jasperreports6.swing.JRDesignViewer viewer = new net.sf.jasperreports6.swing.JRDesignViewer(jasperReportsContext, sourceFile, isXML);
		...
		) throws JRException
	{
		...
		net.sf.jasperreports6.swing.JRDesignViewer viewer = new net.sf.jasperreports6.swing.JRDesignViewer(jasperReportsContext, is, isXML);
		this.pnlMain.add(viewer, BorderLayout.CENTER);
	}
		...
		) throws JRException
	{
		...
		net.sf.jasperreports6.swing.JRDesignViewer viewer = new net.sf.jasperreports6.swing.JRDesignViewer(jasperReportsContext, report);
		this.pnlMain.add(viewer, BorderLayout.CENTER);
	}
