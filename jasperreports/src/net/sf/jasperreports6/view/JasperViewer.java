...
/**
 * This class uses the {@link net.sf.jasperreports6.swing.JRViewer} component to display reports. 
...
public class JasperViewer extends javax.swing.JFrame 
{
	 ...
	 *
	 */
	protected net.sf.jasperreports6.swing.JRViewer viewer;
		...
		)  throws JRException
	{
		...
		this.viewer = new net.sf.jasperreports6.swing.JRViewer(jasperReportsContext, sourceFile, isXMLFile, locale, resBundle);
		...
		) throws JRException
	{
		...
		this.viewer = new net.sf.jasperreports6.swing.JRViewer(jasperReportsContext, is, isXMLFile, locale, resBundle);
		this.pnlMain.add(this.viewer, BorderLayout.CENTER);
	}
		...
		)
	{
		...
		this.viewer = new net.sf.jasperreports6.swing.JRViewer(jasperReportsContext, jasperPrint, locale, resBundle);
		this.pnlMain.add(this.viewer, BorderLayout.CENTER);
	}
	...
	private void initComponents() {//GEN-BEGIN:initComponents
		...
		float zoom = ((float) screenResolution) / net.sf.jasperreports6.swing.JRViewerPanel.REPORT_RESOLUTION;
