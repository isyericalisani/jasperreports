 ...
 * {@link net.sf.jasperreports6.engine.design.JasperDesign JasperDesign} objects into 
 * {@link net.sf.jasperreports6.engine.JasperReport JasperReport} objects. Both classes are 
 * implementations of the same basic {@link net.sf.jasperreports6.engine.JRReport JRReport} 
 * interface. However, {@link net.sf.jasperreports6.engine.JasperReport JasperReport} objects cannot be modified once they are produced, 
 * while {@link net.sf.jasperreports6.engine.design.JasperDesign JasperDesign} objects can. This is because some modifications made on the 
 ...
 * updated. 
 * </p><p>
 * {@link net.sf.jasperreports6.engine.design.JasperDesign JasperDesign} objects are produced when parsing JRXML files using the 
 * {@link net.sf.jasperreports6.engine.xml.JRXmlLoader JRXmlLoader} or created directly by the parent 
 ...
 * </p><p>
 * A {@link net.sf.jasperreports6.engine.design.JasperDesign JasperDesign} object must be subject to the report compilation process to produce a 
 * {@link net.sf.jasperreports6.engine.JasperReport JasperReport} object. 
 * </p><p>
 * Central to this process is the {@link net.sf.jasperreports6.engine.design.JRCompiler JRCompiler} 
 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.compilers.JRGroovyCompiler JRGroovyCompiler}</li>
 * <li>{@link net.sf.jasperreports6.compilers.JavaScriptCompiler JavaScriptCompiler}</li>
 * </ul>
...
*/
package net.sf.jasperreports6.compilers;