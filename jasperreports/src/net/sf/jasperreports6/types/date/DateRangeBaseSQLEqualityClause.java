...
import net.sf.jasperreports6.engine.query.JRClauseFunction;
import net.sf.jasperreports6.engine.query.JRClauseTokens;
import net.sf.jasperreports6.engine.query.JRQueryClauseContext;
import net.sf.jasperreports6.engine.query.JRSqlAbstractEqualClause;
