...
import net.sf.jasperreports6.export.CommonExportConfiguration;
import net.sf.jasperreports6.export.PropertiesExporterConfigurationFactory;
...
public class ParametersExporterConfigurationFactory<C extends CommonExportConfiguration>
{
		...
		)
	{
		...
		Boolean param = (Boolean) parameters.get(net.sf.jasperreports6.engine.JRExporterParameter.PARAMETERS_OVERRIDE_REPORT_HINTS);
		if (param == null)
		{
			isParametersOverrideHints = 
				JRPropertiesUtil.getInstance(
					jasperReportsContext
						...
						net.sf.jasperreports6.engine.JRExporterParameter.PROPERTY_EXPORT_PARAMETERS_OVERRIDE_REPORT_HINTS
						);
		}
		else
		{
...
//				(Class<?>[]) allInterfaces.toArray(new Class<?>[allInterfaces.size()]),
	...
	protected Object getPropertyValue(Method method)
	{
		...
		net.sf.jasperreports6.engine.JRExporterParameter parameter = null;
		...
		if (exporterParameter != null)
		{
			...
			{
				parameter = 
					(net.sf.jasperreports6.engine.JRExporterParameter)exporterParameter.type().getField(
