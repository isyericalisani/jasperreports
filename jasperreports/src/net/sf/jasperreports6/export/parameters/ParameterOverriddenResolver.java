...
public class ParameterOverriddenResolver implements ParameterResolver
{
	...
	private final Map<net.sf.jasperreports6.engine.JRExporterParameter, Object> parameters;
	...
	@Override
	public String getStringParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property)
	{
		String value;
	...
	@Override
	public String[] getStringArrayParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String propertyPrefix)
	{
	...
	@Override
	public Map<String, String> getMapParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String  propertyPrefix)
	{
	...
	@Override
	public String getStringParameterOrDefault(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property)
	{
		String value;
		JRPropertiesMap hintsMap = jasperPrint.getPropertiesMap();
		if (hintsMap != null && hintsMap.containsProperty(property))
	...
	@Override
	public boolean getBooleanParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property, boolean defaultValue)
	{
		boolean value;
		JRPropertiesMap hintsMap = jasperPrint.getPropertiesMap();
		if (hintsMap != null && hintsMap.containsProperty(property))
	...
	@Override
	public int getIntegerParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property, int defaultValue)
	{
		int value;
		JRPropertiesMap hintsMap = jasperPrint.getPropertiesMap();
		if (hintsMap != null && hintsMap.containsProperty(property))
	...
	@Override
	public float getFloatParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property, float defaultValue)
	{
		float value;
		JRPropertiesMap hintsMap = jasperPrint.getPropertiesMap();
		if (hintsMap != null && hintsMap.containsProperty(property))
	...
	@Override
	public Character getCharacterParameter(net.sf.jasperreports6.engine.JRExporterParameter parameter, String property)
	{
		Character value;
		JRPropertiesMap hintsMap = jasperPrint.getPropertiesMap();
		if (hintsMap != null && hintsMap.containsProperty(property))
