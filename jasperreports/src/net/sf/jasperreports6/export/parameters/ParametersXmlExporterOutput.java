...
import net.sf.jasperreports6.engine.export.FileXmlResourceHandler;
...
public class ParametersXmlExporterOutput extends ParametersWriterExporterOutput implements XmlExporterOutput
{
		...
		if (sb == null)
		{
			...
			if (writer == null)
			{
				...
				if (os == null)
				{
					...
					Boolean isEmbeddingImagesParameter = (Boolean)parameters.get(net.sf.jasperreports6.engine.export.JRXmlExporterParameter.IS_EMBEDDING_IMAGES);
	...
	{
		encoding = (String)parameters.get(net.sf.jasperreports6.engine.JRExporterParameter.CHARACTER_ENCODING);
		if (encoding == null)
		{
