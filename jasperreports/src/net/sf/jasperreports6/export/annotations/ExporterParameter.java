 ...
 */
package net.sf.jasperreports6.export.annotations;
...
public @interface ExporterParameter 
{
	...
	Class<? extends net.sf.jasperreports6.engine.JRExporterParameter> type() default net.sf.jasperreports6.engine.JRExporterParameter.class;
