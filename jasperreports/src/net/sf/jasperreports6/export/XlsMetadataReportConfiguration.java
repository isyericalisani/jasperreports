...
public interface XlsMetadataReportConfiguration extends XlsReportConfiguration
{
	 ...
	 */
	@Property(
			name = "net.sf.jasperreports6.export.xls.column.names.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_EXPORT,
	...
	@ExporterParameter(
		type=net.sf.jasperreports6.engine.export.JRXlsAbstractMetadataExporterParameter.class, 
		name="WRITE_HEADER"
		)
	@ExporterProperty(
