...
import net.sf.jasperreports6.engine.export.JRCsvMetadataExporter;
...
public interface CsvMetadataReportConfiguration extends CsvReportConfiguration
{
	 ...
	 */
	@Property(
			name = "net.sf.jasperreports6.export.csv.column.names.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_EXPORT,
	...
	@ExporterParameter(
		type=net.sf.jasperreports6.engine.export.JRCsvMetadataExporterParameter.class, 
		name="WRITE_HEADER"
		) 
	@ExporterProperty(
