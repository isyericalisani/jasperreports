...
public interface ReportExportConfiguration extends CommonExportConfiguration
{
	...
	/**
	 * Return a {@link net.sf.jasperreports6.engine.export.JRExportProgressMonitor JRExportProgressMonitor} instance for monitoring export status. 
	...
	/**
	 * Returns an instance of the {@link net.sf.jasperreports6.engine.export.ExporterFilter ExporterFilter} interface to be used by the exporter 
	...
	/**
	 * Returns a {@link net.sf.jasperreports6.engine.export.JRHyperlinkProducerFactory JRHyperlinkProducerFactory} which should be used for custom 
