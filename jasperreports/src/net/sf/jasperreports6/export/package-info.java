 ...
 * is always invoked by calling the {@link net.sf.jasperreports6.export.Exporter#exportReport() exportReport()} method of the 
 ...
 * its defined {@link net.sf.jasperreports6.engine.JRAbstractExporter#setExporterInput(ExporterInput) setExporterInput(ExporterInput)} method. 
 * </p><p>
 ...
 * {@link net.sf.jasperreports6.engine.JRAbstractExporter#setExporterOutput(ExporterOutput) setExporterOutput(O exporterOutput)} method inherited from their 
 ...
 * <code>public void {@link net.sf.jasperreports6.engine.JRAbstractExporter#setConfiguration(ExporterConfiguration) setConfiguration(C configuration)}</code> and 
 * <code>public void {@link net.sf.jasperreports6.engine.JRAbstractExporter#setConfiguration(ReportExportConfiguration) setConfiguration(RC configuration)}</code> 
 ...
 */
package net.sf.jasperreports6.export;
