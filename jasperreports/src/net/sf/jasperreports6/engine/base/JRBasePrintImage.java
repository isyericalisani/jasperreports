...
import net.sf.jasperreports6.engine.JRHyperlinkHelper;
...
public class JRBasePrintImage extends JRBasePrintGraphicElement implements JRPrintImage
{
	 ...
	 */
	@Override
	public net.sf.jasperreports6.engine.Renderable getRenderable()
	{
		return net.sf.jasperreports6.engine.RenderableUtil.getWrappingRenderable(renderable);
	}
		
	/**
	 * @deprecated Replaced by {@link #setRenderer(net.sf.jasperreports6.renderers.Renderable)}.
	 */
	@Override
	public void setRenderable(net.sf.jasperreports6.engine.Renderable renderable)
	{
	 ...
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.HorizontalAlignEnum horizontalAlignmentValue;
	/**
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.type.VerticalAlignEnum verticalAlignmentValue;
	/**
	 * @deprecated
	 */
	 ...
	 * @deprecated
	 */
	private net.sf.jasperreports6.engine.JRRenderable renderer;
	/**
	 * @deprecated
	 */
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		{
			horizontalAlignmentValue = net.sf.jasperreports6.engine.type.HorizontalAlignEnum.getByValue(horizontalAlignment);
			verticalAlignmentValue = net.sf.jasperreports6.engine.type.VerticalAlignEnum.getByValue(verticalAlignment);
		...
		if (renderer != null && renderable == null)
		{
			...
			{
				renderable = net.sf.jasperreports6.engine.RenderableUtil.getWrappingRenderable(renderer);
			}
		}

		if (PSEUDO_SERIAL_VERSION_UID < JRConstants.PSEUDO_SERIAL_VERSION_UID_6_0_2)
		{
			horizontalImageAlign = net.sf.jasperreports6.engine.type.HorizontalAlignEnum.getHorizontalImageAlignEnum(horizontalAlignmentValue);
			verticalImageAlign = net.sf.jasperreports6.engine.type.VerticalAlignEnum.getVerticalImageAlignEnum(verticalAlignmentValue);
