...
import net.sf.jasperreports6.engine.fill.JRFiller;
import net.sf.jasperreports6.engine.fill.JasperReportSource;
import net.sf.jasperreports6.engine.fill.SimpleJasperReportSource;
...
import net.sf.jasperreports6.repo.ResourceInfo;
import net.sf.jasperreports6.repo.SimpleRepositoryResourceContext;
 ...
 * <ul>
 * <li>Methods that receive an instance of the {@link net.sf.jasperreports6.engine.JRDataSource} interface
 ...
 * the returned <code>java.sql.ResultSet</code> object inside a {@link net.sf.jasperreports6.engine.JRResultSetDataSource}
 * instance. 
 * </ul>
 * 
 * @see net.sf.jasperreports6.engine.JasperReport
 * @see net.sf.jasperreports6.engine.JRDataSource
 * @see net.sf.jasperreports6.engine.fill.JRFiller
...
public final class JasperFillManager
{
	...
	{
		net.sf.jasperreports6.engine.util.SimpleFileResolver fileResolver =
			new net.sf.jasperreports6.engine.util.SimpleFileResolver(
