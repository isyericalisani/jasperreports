 ...
 * a {@link net.sf.jasperreports6.engine.JRGenericPrintElement} at fill time.</li>
 ...
 * {@link net.sf.jasperreports6.engine.export.GenericElementHtmlHandler} interface
 * (which extends the
 * {@link net.sf.jasperreports6.engine.export.GenericElementHandler} interface that is
 * common to all export handlers).
 * Handler bundles are deployed as JasperReports extensions, using
 * {@link net.sf.jasperreports6.engine.export.GenericElementHandlerBundle} as
 * extension type. JasperReports includes
 * {@link net.sf.jasperreports6.engine.export.DefaultElementHandlerBundle}, a
 * convenience handler bundle implementation that wraps a map of handlers per element
 * type and exporter type.
 * 
 * @see net.sf.jasperreports6.engine.JRGenericPrintElement
 * @see net.sf.jasperreports6.engine.export.GenericElementHandler
 * @see net.sf.jasperreports6.engine.export.GenericElementHandlerBundle
