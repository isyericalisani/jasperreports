 ...
 */
package net.sf.jasperreports6.engine.analytics.dataset;
...
import net.sf.jasperreports6.crosstabs.fill.calculation.BucketingService;
...
import net.sf.jasperreports6.crosstabs.fill.calculation.BucketingService.BucketMap;
...
import net.sf.jasperreports6.engine.analytics.data.AxisLevel;
import net.sf.jasperreports6.engine.analytics.data.AxisLevelNode;
import net.sf.jasperreports6.engine.analytics.data.MappedPropertyValues;
import net.sf.jasperreports6.engine.analytics.data.Measure;
import net.sf.jasperreports6.engine.analytics.data.MultiAxisDataSource;
import net.sf.jasperreports6.engine.analytics.data.PropertyValues;
import net.sf.jasperreports6.engine.analytics.data.StandardAxisLevel;
import net.sf.jasperreports6.engine.analytics.data.StandardMeasure;
import net.sf.jasperreports6.engine.analytics.data.StandardMeasureValue;
import net.sf.jasperreports6.engine.analytics.data.AxisLevel.Type;
import net.sf.jasperreports6.engine.fill.JRCalculator;
import net.sf.jasperreports6.engine.fill.JRDefaultIncrementerFactory;
import net.sf.jasperreports6.engine.fill.JRExpressionEvalException;
import net.sf.jasperreports6.engine.fill.JRExtendedIncrementerFactory;
import net.sf.jasperreports6.engine.fill.JRFillExpressionEvaluator;
import net.sf.jasperreports6.engine.fill.JRIncrementerFactoryCache;
import net.sf.jasperreports6.engine.util.SingleValue;
import net.sf.jasperreports6.engine.util.ValuePropertiesWrapper;
import net.sf.jasperreports6.engine.util.ValuePropertiesWrapperComparator;
...
public class MultiAxisDataService
{
	...
	protected class DataSource implements MultiAxisDataSource
	{
		...
		@Override
		public List<? extends net.sf.jasperreports6.engine.analytics.data.MeasureValue> getMeasureValues(AxisLevelNode... nodes)
		{
			if (nodes.length == 0)
			{
			...
			List<net.sf.jasperreports6.engine.analytics.data.MeasureValue> measureValues = new ArrayList<>(values.length);
