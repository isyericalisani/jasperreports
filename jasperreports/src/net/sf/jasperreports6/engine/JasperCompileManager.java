 ...
 */
package net.sf.jasperreports6.engine;
...
import net.sf.jasperreports6.engine.design.JRCompiler;
import net.sf.jasperreports6.engine.design.JRJavacCompiler;
import net.sf.jasperreports6.engine.design.JRJdk13Compiler;
import net.sf.jasperreports6.engine.design.JRJdtCompiler;
import net.sf.jasperreports6.engine.design.JRValidationFault;
import net.sf.jasperreports6.engine.design.JRVerifier;
import net.sf.jasperreports6.engine.design.JasperDesign;
import net.sf.jasperreports6.engine.fill.JREvaluator;
import net.sf.jasperreports6.engine.fill.JasperReportsContextAware;
 ...
 * {@link net.sf.jasperreports6.engine.design.JasperDesign} object and receiving the
 * corresponding {@link net.sf.jasperreports6.engine.JasperReport} object.
 * </p><p>
 * Other utility methods include report template verification and JRXML report template
 * generation for in-memory constructed
 * {@link net.sf.jasperreports6.engine.design.JasperDesign} class instances. These
 ...
 * {@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_PREFIX net.sf.jasperreports.compiler.&lt;language&gt;} to determine whether a compiler
 ...
 * configuration property called {@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_CLASS net.sf.jasperreports.compiler.class} to allow
 ...
 * {@link net.sf.jasperreports6.engine.design.JRJdtCompiler} implementation is used.
 * </p><p>
 ...
 * report compilation.
 * <dl>
 * <dt>{@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_PREFIX net.sf.jasperreports.compiler.&lt;language&gt;}<dt>
 * <dd>Such properties are used for indicating the name of the class that implements the
 * {@link net.sf.jasperreports6.engine.design.JRCompiler} interface to be instantiated by 
 ...
 * {@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_PREFIX net.sf.jasperreports.compiler.&lt;language&gt;} to the desired compiler
 ...
 * <br/>
 * Note that the classes implementing the {@link net.sf.jasperreports6.engine.design.JRCompiler} 
 * interface can also be used directly in
 * the programs without having to call them through this facade class.</dd>
 * <dt>{@link net.sf.jasperreports6.engine.xml.JRReportSaxParserFactory#COMPILER_XML_VALIDATION net.sf.jasperreports.compiler.xml.validation}<dt>
 ...
 * not recommended.</dd>
 * <dt>{@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_CLASSPATH net.sf.jasperreports.compiler.classpath}<dt>
 * <dd>This property
 ...
 * <dt>{@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_TEMP_DIR net.sf.jasperreports.compiler.temp.dir}<dt>
 ...
 * <dt>{@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_KEEP_JAVA_FILE net.sf.jasperreports.compiler.keep.java.file}<dt>
 ...
 * @see net.sf.jasperreports6.engine.design.JasperDesign
 * @see net.sf.jasperreports6.engine.design.JRCompiler
 * @see net.sf.jasperreports6.engine.design.JRJdtCompiler
 * @see net.sf.jasperreports6.engine.design.JRVerifier
 * @see net.sf.jasperreports6.engine.xml.JRXmlLoader
 * @see net.sf.jasperreports6.engine.xml.JRXmlWriter
 * @see net.sf.jasperreports6.engine.util.JRLoader
 * @see net.sf.jasperreports6.engine.util.JRSaver
...
public final class JasperCompileManager
{
	 ...
	 * {@link net.sf.jasperreports6.engine.JasperReport} object representing the compiled report design,
	 ...
	 * @return resulting file name containing a serialized {@link net.sf.jasperreports6.engine.JasperReport} object 
	 */
	 ...
	 * {@link net.sf.jasperreports6.engine.JasperReport} object representing 
	...
	{
		System.out.println("-JasperCompileManager-222-inputStream:"+inputStream);
		JasperDesign jasperDesign = JRXmlLoader.load(inputStream);
