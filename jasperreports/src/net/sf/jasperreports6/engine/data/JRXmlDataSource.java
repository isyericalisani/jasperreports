...
import net.sf.jasperreports6.engine.util.JRXmlUtils;
import net.sf.jasperreports6.engine.util.xml.JRXPathExecuter;
import net.sf.jasperreports6.engine.util.xml.JRXPathExecuterUtils;
 ...
 * custom property at field level. The use of the {@link net.sf.jasperreports6.engine.JRField#getDescription() field description} to specify the XPath expression 
