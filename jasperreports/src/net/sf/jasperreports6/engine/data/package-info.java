 ...
 * {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource} object as the data source of the 
 ...
 * The {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource} interface is very simple. It  
 ...
 * {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource} interface.
 * </p>
 * <h3>JDBC Data Sources</h3>
 * The {@link net.sf.jasperreports6.engine.JRResultSetDataSource JRResultSetDataSource} is a very useful 
 * implementation of the {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource} interface 
 ...
 * {@link net.sf.jasperreports6.engine.JRResultSetDataSource JRResultSetDataSource} instance. The only thing 
 ...
 * <p>
 * The {@link net.sf.jasperreports6.engine.data.JRBeanArrayDataSource JRBeanArrayDataSource} is for 
 * wrapping an array of JavaBean objects to use for filling a report with data, and the 
 * {@link net.sf.jasperreports6.engine.data.JRBeanCollectionDataSource JRBeanCollectionDataSource} is for 
 ...
 * <p>
 * The {@link net.sf.jasperreports6.engine.data.JRMapArrayDataSource JRMapArrayDataSource} wraps an array 
 * of <code>java.util.Map</code> objects, and 
 * {@link net.sf.jasperreports6.engine.data.JRMapCollectionDataSource JRMapCollectionDataSource} can be used 
 ...
 * {@link net.sf.jasperreports6.engine.data.JRTableModelDataSource JRTableModelDataSource} instance before 
 ...
 * ({@link net.sf.jasperreports6.engine.data.JRXmlDataSource JRXmlDataSource}) that is based on DOM 
 ...
 * for each record is needed. The field's XPath expression is provided by the {@link net.sf.jasperreports6.engine.data.AbstractXmlDataSource#PROPERTY_FIELD_EXPRESSION} 
 * custom field property. The use of the {@link net.sf.jasperreports6.engine.JRField#getDescription() field description} to specify the XPath expression 
 ...
 * {@link net.sf.jasperreports6.engine.util.xml.JRXPathExecuter JRXPathExecuter}. 
 * </p><p> 
 * The XPath executer implementation used by XML data sources can be configured via a 
 * JasperReports property named {@link net.sf.jasperreports6.engine.util.xml.JRXPathExecuterUtils#PROPERTY_XPATH_EXECUTER_FACTORY net.sf.jasperreports.xpath.executer.factory}. 
 * This property gives the name of a XPath executer factory class, which has to implement 
 * the {@link net.sf.jasperreports6.engine.util.xml.JRXPathExecuterFactory JRXPathExecuterFactory}. 
 ...
 * {@link net.sf.jasperreports6.engine.util.xml.JRXPathExecuterUtils#PROPERTY_XPATH_EXECUTER_FACTORY net.sf.jasperreports.xpath.executer.factory} property to 
 ...
 * {@link net.sf.jasperreports6.engine.util.xml.JaxenXPathExecuterFactory JaxenXPathExecuterFactory}. 
 * </p>
 ...
 * data from a text file into a {@link net.sf.jasperreports6.engine.data.JRCsvDataSource JRCsvDataSource}. 
 * The CSV data source usually needs to read a file from disk, or at least from an input 
 * stream. Thus, the {@link net.sf.jasperreports6.engine.data.JRCsvDataSource JRCsvDataSource} can be initialized in three ways, depending on 
 ...
 * {@link net.sf.jasperreports6.engine.data.JRCsvDataSource JRCsvDataSource} instance by calling its 
 ...
 * {@link net.sf.jasperreports6.engine.data.ExcelDataSource ExcelDataSource} data source 
 ...
 * The {@link net.sf.jasperreports6.engine.JREmptyDataSource JREmptyDataSource} class is a very simple 
 ...
 * The {@link net.sf.jasperreports6.engine.JRRewindableDataSource JRRewindableDataSource} is an extension of 
 * the basic {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource}interface, to which it adds 
 ...
 * {@link net.sf.jasperreports6.engine.JRResultSetDataSource JRResultSetDataSource}, which does not support 
 ...
 * {@link net.sf.jasperreports6.engine.JRDataSourceProvider JRDataSourceProvider} interface and make it 
 ...
 * {@link net.sf.jasperreports6.engine.JRDataSourceProvider JRDataSourceProvider} 
 ...
 * </p><p>
 * The {@link net.sf.jasperreports6.engine.data.JRAbstractBeanDataSourceProvider JRAbstractBeanDataSourceProvider} 
 ...
 */
package net.sf.jasperreports6.engine.data;
