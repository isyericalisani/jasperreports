...
import net.sf.jasperreports6.engine.JRDataSourceProvider;
...
import net.sf.jasperreports6.engine.design.JRDesignField;
...
public abstract class JRAbstractBeanDataSourceProvider implements JRDataSourceProvider 
{
	...
	/**
	 * @see net.sf.jasperreports6.engine.JRDataSourceProvider#supportsGetFieldsOperation()
	 */
	@Override
	...
	/**
	 * @see net.sf.jasperreports6.engine.JRDataSourceProvider#getFields(net.sf.jasperreports6.engine.JasperReport)
	 */
	@Override
