 ...
 */
package net.sf.jasperreports6.engine.util;
...
import net.sf.jasperreports6.engine.type.TabStopAlignEnum;
...
import net.sf.jasperreports6.export.WriterExporterOutput;
...
public class JRApiWriter
{
	...
	protected void writeReport(JRReport report, Writer aWriter)
	{
		...
		write("\n");
		write("import net.sf.jasperreports6.charts.*;\n");
		write("import net.sf.jasperreports6.charts.design.*;\n");
		write("import net.sf.jasperreports6.charts.util.*;\n");
		write("import net.sf.jasperreports6.crosstabs.*;\n");
		write("import net.sf.jasperreports6.crosstabs.design.*;\n");
		write("import net.sf.jasperreports6.crosstabs.fill.calculation.BucketDefinition;\n");
		write("import net.sf.jasperreports6.engine.*;\n");
		write("import net.sf.jasperreports6.engine.base.JRBaseChartPlot.JRBaseSeriesColor;\n");
		write("import net.sf.jasperreports6.engine.base.JRBaseFont;\n");
		write("import net.sf.jasperreports6.engine.design.*;\n");
		write("import net.sf.jasperreports6.engine.type.*;\n");
		write("import net.sf.jasperreports6.engine.util.ReportCreator;\n");
		write("\n\n");
