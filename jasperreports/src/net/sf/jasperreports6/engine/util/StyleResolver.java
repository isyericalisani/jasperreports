...
import net.sf.jasperreports6.charts.JRCategoryAxisFormat;
import net.sf.jasperreports6.charts.JRTimeAxisFormat;
import net.sf.jasperreports6.charts.JRValueAxisFormat;
import net.sf.jasperreports6.charts.JRXAxisFormat;
import net.sf.jasperreports6.charts.JRYAxisFormat;
...
import net.sf.jasperreports6.engine.JRCommonElement;
import net.sf.jasperreports6.engine.JRCommonGraphicElement;
import net.sf.jasperreports6.engine.JRCommonImage;
import net.sf.jasperreports6.engine.JRCommonRectangle;
...
import net.sf.jasperreports6.engine.JRImageAlignment;
import net.sf.jasperreports6.engine.JRLineBox;
import net.sf.jasperreports6.engine.JRParagraph;
import net.sf.jasperreports6.engine.JRParagraphContainer;
import net.sf.jasperreports6.engine.JRPen;
import net.sf.jasperreports6.engine.JRPenContainer;
...
import net.sf.jasperreports6.engine.JRTextAlignment;
...
import net.sf.jasperreports6.engine.base.JRBoxPen;
