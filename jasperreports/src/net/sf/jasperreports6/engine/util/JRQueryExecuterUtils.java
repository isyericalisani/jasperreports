...
public final class JRQueryExecuterUtils
{
	...
	{
		List<net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle> oldBundles = jasperReportsContext.getExtensions(
				net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle.class);
		for (Iterator<net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle> it = oldBundles.iterator(); it.hasNext();)
		{
			net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle bundle = it.next();
			net.sf.jasperreports6.engine.query.JRQueryExecuterFactory factory = bundle.getQueryExecuterFactory(language);
			if (factory != null)
			{
	...
	{
		private net.sf.jasperreports6.engine.query.JRQueryExecuterFactory factory;
		
		public WrappingQueryExecuterFactory(net.sf.jasperreports6.engine.query.JRQueryExecuterFactory factory)
		{
