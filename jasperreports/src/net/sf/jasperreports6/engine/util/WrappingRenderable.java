 ...
 */
public class WrappingRenderable implements net.sf.jasperreports6.engine.Renderable
{
	/**
	 *
	 */
	 ...
	 *
	 */
	private net.sf.jasperreports6.engine.JRRenderable renderable;
	
	
	/**
	 *
	 */
	public WrappingRenderable(net.sf.jasperreports6.engine.JRRenderable renderable)
	{
	...
	public net.sf.jasperreports6.engine.type.RenderableTypeEnum getTypeValue() {
		return net.sf.jasperreports6.engine.type.RenderableTypeEnum.getByValue(renderable.getType());
	}
