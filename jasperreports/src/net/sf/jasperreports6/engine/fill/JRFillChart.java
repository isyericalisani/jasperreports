...
import net.sf.jasperreports6.charts.util.CategoryChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.ChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.ChartUtil;
import net.sf.jasperreports6.charts.util.HighLowChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.JRMeterInterval;
import net.sf.jasperreports6.charts.util.MultiAxisChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.PieChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.TimePeriodChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.TimeSeriesChartHyperlinkProvider;
import net.sf.jasperreports6.charts.util.XYChartHyperlinkProvider;
import net.sf.jasperreports6.engine.JRAbstractChartCustomizer;
import net.sf.jasperreports6.engine.JRChart;
import net.sf.jasperreports6.engine.JRChartCustomizer;
...
import net.sf.jasperreports6.engine.NamedChartCustomizer;
import net.sf.jasperreports6.engine.JRChartPlot.JRSeriesColor;
import net.sf.jasperreports6.engine.base.JRBaseChart;
