...
import net.sf.jasperreports6.engine.JRBiConsumer;
...
public class DatasetExecution
{
	...
	public DatasetExecution(RepositoryContext repositoryContext, JasperReport report, Map<String,Object> parameters)
	{
		...
		JasperReportsContext depContext = 
			net.sf.jasperreports6.engine.util.LocalJasperReportsContext.getLocalContext(repositoryContext.getJasperReportsContext(), parameters);
