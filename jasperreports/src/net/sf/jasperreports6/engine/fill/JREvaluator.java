...
import net.sf.jasperreports6.compilers.DirectExpressionEvaluator;
...
import net.sf.jasperreports6.functions.FunctionSupport;
...
public abstract class JREvaluator implements DatasetExpressionEvaluator
{
	 ...
	 * @throws Throwable
	 * @see net.sf.jasperreports6.engine.JRExpression#EVALUATION_DEFAULT
	 ...
	 * @return the result of the evaluation
	 * @throws Throwable
	 * @see net.sf.jasperreports6.engine.JRExpression#EVALUATION_OLD
	 ...
	 * @return the result of the evaluation
	 * @throws Throwable
	 * @see net.sf.jasperreports6.engine.JRExpression#EVALUATION_ESTIMATED
