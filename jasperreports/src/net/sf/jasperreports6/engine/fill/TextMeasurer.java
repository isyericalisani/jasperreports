...
import net.sf.jasperreports6.engine.export.AbstractTextRenderer;
import net.sf.jasperreports6.engine.export.AwtTextRenderer;
import net.sf.jasperreports6.engine.util.DelegatePropertiesHolder;
...
import net.sf.jasperreports6.engine.util.ParagraphUtil;
 ...
 * {@link net.sf.jasperreports6.engine.util.JRTextMeasurerUtil#PROPERTY_TEXT_MEASURER_FACTORY net.sf.jasperreports.text.measurer.factory} property.
 * The property can be set globally (in <code>jasperreports.properties</code> or via the
 * {@link net.sf.jasperreports6.engine.JRPropertiesUtil#setProperty(String, String)} method), at
 ...
 * {@link net.sf.jasperreports6.engine.util.JRTextMeasurerFactory} interface, or an
 ...
 * {@link net.sf.jasperreports6.engine.fill.TextMeasurerFactory}; the factory is also
 ...
 * {@link net.sf.jasperreports6.engine.JRTextElement#PROPERTY_TRUNCATE_AT_CHAR net.sf.jasperreports.text.truncate.at.char}
 ...
 * of the {@link net.sf.jasperreports6.engine.JRTextElement#PROPERTY_TRUNCATE_SUFFIX net.sf.jasperreports.text.truncate.suffix} 
 ...
 * {@link net.sf.jasperreports6.engine.JRTextElement#PROPERTY_PRINT_KEEP_FULL_TEXT net.sf.jasperreports.print.keep.full.text}
 ...
 * 
 * @see net.sf.jasperreports6.engine.JRTextElement#PROPERTY_PRINT_KEEP_FULL_TEXT
 * @see net.sf.jasperreports6.engine.JRTextElement#PROPERTY_TRUNCATE_AT_CHAR
 * @see net.sf.jasperreports6.engine.JRTextElement#PROPERTY_TRUNCATE_SUFFIX
 * @see net.sf.jasperreports6.engine.fill.TextMeasurerFactory
 * @see net.sf.jasperreports6.engine.util.JRTextMeasurerUtil#PROPERTY_TEXT_MEASURER_FACTORY
