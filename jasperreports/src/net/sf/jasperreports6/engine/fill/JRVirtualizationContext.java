...
import net.sf.jasperreports6.engine.JRVirtualizable;
import net.sf.jasperreports6.engine.JRVirtualizationHelper;
...
import net.sf.jasperreports6.engine.base.VirtualizableElementList;
import net.sf.jasperreports6.engine.fonts.FontUtil;
import net.sf.jasperreports6.engine.util.DeepPrintElementVisitor;
import net.sf.jasperreports6.engine.util.UniformPrintElementVisitor;
