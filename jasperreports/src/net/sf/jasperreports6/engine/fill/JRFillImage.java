...
import net.sf.jasperreports6.repo.ResourcePathKey;
		...
		) throws JRException
	{
		...
		if (source != null)
		{
			...
			else
			{
				...
				net.sf.jasperreports6.engine.JRRenderable deprecatedRenderable = 
					source instanceof net.sf.jasperreports6.engine.JRRenderable 
					? (net.sf.jasperreports6.engine.JRRenderable)source 
					: null;
				...
				else if (deprecatedRenderable != null)
				{
					...
					Renderable wrappingRenderable = 
						net.sf.jasperreports6.engine.RenderableUtil.getWrappingRenderable(deprecatedRenderable);
