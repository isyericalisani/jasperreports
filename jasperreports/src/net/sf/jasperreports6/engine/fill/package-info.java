 ...
 * <li>data source</li>
 * </ul>
 * The output is always a single, final {@link net.sf.jasperreports6.engine.JasperPrint} 
 * document ready to be viewed, printed, or exported to other formats. 
 * </p><p>
 * The {@link net.sf.jasperreports6.engine.JasperFillManager} class is usually used for 
 ...
 * {@link net.sf.jasperreports6.engine.JasperReport} objects. After getting the report template, 
 * the report filling methods are calling the related <code>fill(...)</code> method in the 
 * {@link net.sf.jasperreports6.engine.fill.JRFiller} class, that actually fills the report.
 * </p><p>
 ...
 * {@link net.sf.jasperreports6.engine.util.JRLoader} utility class. This way, one can 
 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} objects, which are serializable. This 
 * allows the parent application to store them or transfer them over the network if needed. 
 * <p>
 * At the top level, a {@link net.sf.jasperreports6.engine.JasperPrint} object contains some document-specific information, 
 ...
 * ({@link net.sf.jasperreports6.engine.JRPrintPage} instances), each page having a 
 ...
 * {@link net.sf.jasperreports6.engine.fill.JRVerticalFiller} class.</li>
 * <li><code>Horizontal</code> - meaning that they first run from left to right and then from top to bottom. In this case 
 * the report is filled using methods in the {@link net.sf.jasperreports6.engine.fill.JRHorizontalFiller} class.</li>
 * </ul>
 ...
 * {@link net.sf.jasperreports6.engine.fill.AsynchronousFillHandle} class to be used 
 ...
 * {@link net.sf.jasperreports6.engine.fill.AsynchronousFilllListener} interface. The 
 ...
 * <ul>
 * <li>The handle is created by calling the static <code>createHandle()</code> methods in {@link net.sf.jasperreports6.engine.fill.AsynchronousFillHandle AsynchronousFillHandle}  
 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} object could also be very large and might cause 
 ...
 * ({@link net.sf.jasperreports6.engine.JRVirtualizer}) that enables the reporting engine 
 ...
 * {@link net.sf.jasperreports6.engine.JRVirtualizer} interface as the value for the built-in 
 * {@link net.sf.jasperreports6.engine.JRParameter#REPORT_VIRTUALIZER REPORT_VIRTUALIZER} 
 * parameter when filling the report.
 * </p><p>
 * In virtualized form, a generated {@link net.sf.jasperreports6.engine.JasperPrint} document still behaves normally and can 
 ...
 * into temporary files), once completed, a {@link net.sf.jasperreports6.engine.JasperPrint} document can itself be serialized 
 * normally without any loss of information. During the serialization of a virtualized 
 * {@link net.sf.jasperreports6.engine.JasperPrint} object, the program puts back together all the pieces and a single 
 ...
 * {@link net.sf.jasperreports6.engine.fill.JRFileVirtualizer}, which stores document 
 * pages on disk during the filling process to free up memory. Once a {@link net.sf.jasperreports6.engine.JasperPrint} object 
 ...
 * A single {@link net.sf.jasperreports6.engine.fill.JRFileVirtualizer} instance can be shared across multiple report-filling 
 ...
 * {@link net.sf.jasperreports6.engine.fill.JRFileVirtualizer#PROPERTY_TEMP_FILES_SET_DELETE_ON_EXIT net.sf.jasperreports.virtualizer.files.delete.on.exit} configuration property. 
 * </p>
 ...
 * pose additional problems. This makes the use of the {@link net.sf.jasperreports6.engine.fill.JRFileVirtualizer} 
 ...
 * {@link net.sf.jasperreports6.engine.fill.JRSwapFileVirtualizer} class that is 
 * part of the JasperReports library core functionality, and works in combination with a 
 * {@link net.sf.jasperreports6.engine.util.JRSwapFile} instance representing the target 
 * swap file. 
 * </p><p>
 * The {@link net.sf.jasperreports6.engine.util.JRSwapFile} instance has to be created and configured prior to being passed to the 
 ...
 * </p><p>
 * The {@link net.sf.jasperreports6.engine.util.JRConcurrentSwapFile} class 
 ...
 * The {@link net.sf.jasperreports6.engine.fill.JRGzipVirtualizer} is a convenient 
 ...
 * 
 * @see net.sf.jasperreports6.engine.JasperFillManager
 * @see net.sf.jasperreports6.engine.JasperPrint
 * @see net.sf.jasperreports6.engine.JasperReport
 * @see net.sf.jasperreports6.engine.JRPrintPage
 * @see net.sf.jasperreports6.engine.JRVirtualizer
 * @see net.sf.jasperreports6.engine.util.JRConcurrentSwapFile
 * @see net.sf.jasperreports6.engine.util.JRLoader
 * @see net.sf.jasperreports6.engine.util.JRSwapFile
 */
package net.sf.jasperreports6.engine.fill;
