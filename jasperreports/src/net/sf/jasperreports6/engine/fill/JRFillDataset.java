...
import net.sf.jasperreports6.data.cache.CachedDataset;
import net.sf.jasperreports6.data.cache.DataCacheHandler;
import net.sf.jasperreports6.data.cache.DataRecorder;
import net.sf.jasperreports6.data.cache.DataSnapshot;
import net.sf.jasperreports6.data.cache.DataSnapshotException;
import net.sf.jasperreports6.data.cache.DatasetRecorder;
...
import net.sf.jasperreports6.engine.EvaluationType;
import net.sf.jasperreports6.engine.JRAbstractScriptlet;
import net.sf.jasperreports6.engine.JRDataSource;
import net.sf.jasperreports6.engine.JRDataset;
import net.sf.jasperreports6.engine.JRDefaultScriptlet;
...
import net.sf.jasperreports6.engine.data.IndexedDataSource;
import net.sf.jasperreports6.engine.design.JRDesignVariable;
import net.sf.jasperreports6.engine.query.JRQueryExecuter;
import net.sf.jasperreports6.engine.query.QueryExecuterFactory;
import net.sf.jasperreports6.engine.query.SimpleQueryExecutionContext;
import net.sf.jasperreports6.engine.scriptlets.ScriptletFactory;
import net.sf.jasperreports6.engine.scriptlets.ScriptletFactoryContext;
import net.sf.jasperreports6.engine.type.CalculationEnum;
import net.sf.jasperreports6.engine.type.IncrementTypeEnum;
import net.sf.jasperreports6.engine.type.ParameterEvaluationTimeEnum;
import net.sf.jasperreports6.engine.type.PropertyEvaluationTimeEnum;
...
import net.sf.jasperreports6.engine.util.JRQueryExecuterUtils;
import net.sf.jasperreports6.engine.util.JRResourcesUtil;
import net.sf.jasperreports6.engine.util.MD5Digest;
import net.sf.jasperreports6.repo.RepositoryContext;
