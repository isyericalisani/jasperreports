...
import net.sf.jasperreports6.engine.JRRewindableDataSource;
...
import net.sf.jasperreports6.engine.base.JRVirtualPrintPage;
...
public class JRFillSubreport extends JRFillElement implements JRSubreport
{
	...
	{
		JasperReport report;
		if (source instanceof net.sf.jasperreports6.engine.JasperReport)
		{
