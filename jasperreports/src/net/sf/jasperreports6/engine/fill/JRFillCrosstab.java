...
import net.sf.jasperreports6.components.table.fill.TableReport;
import net.sf.jasperreports6.crosstabs.CrosstabColumnCell;
import net.sf.jasperreports6.crosstabs.CrosstabDeepVisitor;
...
import net.sf.jasperreports6.crosstabs.fill.BucketExpressionOrderer;
import net.sf.jasperreports6.crosstabs.fill.BucketOrderer;
import net.sf.jasperreports6.crosstabs.fill.IconLabelFillObjectFactory;
import net.sf.jasperreports6.crosstabs.fill.JRCrosstabExpressionEvaluator;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabCell;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabColumnGroup;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabGroup;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabMeasure;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabObjectFactory;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabParameter;
import net.sf.jasperreports6.crosstabs.fill.JRFillCrosstabRowGroup;
import net.sf.jasperreports6.crosstabs.fill.calculation.BucketDefinition;
import net.sf.jasperreports6.crosstabs.fill.calculation.BucketingServiceContext;
import net.sf.jasperreports6.crosstabs.fill.calculation.ColumnValueInfo;
import net.sf.jasperreports6.crosstabs.fill.calculation.CrosstabBucketingService;
import net.sf.jasperreports6.crosstabs.fill.calculation.CrosstabCell;
import net.sf.jasperreports6.crosstabs.fill.calculation.HeaderCell;
import net.sf.jasperreports6.crosstabs.fill.calculation.MeasureDefinition;
import net.sf.jasperreports6.crosstabs.fill.calculation.OrderByColumnInfo;
import net.sf.jasperreports6.crosstabs.fill.calculation.OrderByColumnOrderer;
import net.sf.jasperreports6.crosstabs.fill.calculation.BucketDefinition.Bucket;
import net.sf.jasperreports6.crosstabs.fill.calculation.MeasureDefinition.MeasureValue;
import net.sf.jasperreports6.crosstabs.interactive.CrosstabInteractiveJsonHandler;
import net.sf.jasperreports6.crosstabs.interactive.DataColumnInfo;
import net.sf.jasperreports6.crosstabs.interactive.RowGroupInteractiveInfo;
import net.sf.jasperreports6.crosstabs.type.CrosstabColumnPositionEnum;
import net.sf.jasperreports6.crosstabs.type.CrosstabPercentageEnum;
import net.sf.jasperreports6.crosstabs.type.CrosstabRowPositionEnum;
...
import net.sf.jasperreports6.engine.JRTextElement;
...
import net.sf.jasperreports6.engine.design.JRDesignComponentElement;
...
import net.sf.jasperreports6.engine.util.JRValueStringUtils;
...
/**
 * Fill-time implementation of a {@link net.sf.jasperreports6.crosstabs.JRCrosstab crosstab}.
 * 
