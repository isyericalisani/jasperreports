 ...
 * create a {@link net.sf.jasperreports6.engine.JRDataSource JRDataSource} to be used by the filling process.
 * <p/>
 ...
 * @see net.sf.jasperreports6.engine.query.QueryExecuterFactory
 */
public interface JRQuery extends JRCloneable
{
	 ...
	 * {@link net.sf.jasperreports6.engine.query.QueryExecuterFactory QueryExecuterFactory} is used to create
	 * a {@link net.sf.jasperreports6.engine.query.JRQueryExecuter JRQueryExecuter} instance.  The query executer
