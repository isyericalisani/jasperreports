...
import net.sf.jasperreports6.export.SimpleOutputStreamExporterOutput;
import net.sf.jasperreports6.export.SimpleWriterExporterOutput;
...
public class JRExporterParameter
{
	 ...
	 * 
	 * @see net.sf.jasperreports6.engine.util.JRResourcesUtil#createURL(String, java.net.URLStreamHandlerFactory)
	 * @deprecated Replaced by {@link JasperReportsContext}.
	 */
