...
public interface JRParameter extends JRPropertiesHolder, JRCloneable
{
	...
	/**
	 * This parameter gives access to the current {@link net.sf.jasperreports6.engine.JasperReport} 
	 ...
	 * {@link net.sf.jasperreports6.engine.JRDataSource} instance.
	 * </p><p>
	...
	/**
	 * A {@link net.sf.jasperreports6.engine.JRDataSource} instance representing the report data source. 
	 * JasperReports defines some convenience implementations
	 * of {@link net.sf.jasperreports6.engine.JRDataSource}, but users may create their own data sources for specific needs.
	 * <p>
	 ...
	 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet} instance, which in this case
	 * is a {@link net.sf.jasperreports6.engine.JRDefaultScriptlet} object. When using
	...
	/**
	 * The {@link net.sf.jasperreports6.engine.JRVirtualizer} to be used for page virtualization.  This parameter is optional.
	 * <p>
	 ...
	 * {@link net.sf.jasperreports6.engine.JRVirtualizer} interface as the value for this
	...
	/**
	 * A {@link net.sf.jasperreports6.engine.util.FormatFactory} instance to be used 
	 ...
	 * {@link net.sf.jasperreports6.engine.util.FormatFactory} interface, which is either
