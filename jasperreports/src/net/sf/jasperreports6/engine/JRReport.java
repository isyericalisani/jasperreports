 ...
 * {@link net.sf.jasperreports6.engine.JRParameter#REPORT_SCRIPTLET REPORT_SCRIPTLET} parameter. 
 ...
 * {@link net.sf.jasperreports6.engine.JRDefaultScriptlet} instance as the report
 * scriptlet.
 * </p>
 ...
 * {@link net.sf.jasperreports6.engine.JRParameter#REPORT_RESOURCE_BUNDLE REPORT_RESOURCE_BUNDLE} 
 ...
 * {@link net.sf.jasperreports6.engine.JRParameter#IS_IGNORE_PAGINATION IS_IGNORE_PAGINATION} parameter.
 ...
 * implementing the {@link net.sf.jasperreports6.engine.util.FormatFactory} interface,
 ...
 * the built-in {@link net.sf.jasperreports6.engine.JRParameter#REPORT_FORMAT_FACTORY REPORT_FORMAT_FACTORY} parameter.
 * </p><p>
 * If neither of the attribute nor the parameter is used, the engine will eventually instantiate
 * the {@link net.sf.jasperreports6.engine.util.DefaultFormatFactory} implementation
 ...
 * This attribute or the built-in {@link net.sf.jasperreports6.engine.JRParameter#REPORT_FORMAT_FACTORY REPORT_FORMAT_FACTORY}
 ...
 * the public method {@link net.sf.jasperreports6.engine.JRPropertiesHolder#getPropertiesMap() getPropertiesMap()} 
 * inherited from the {@link net.sf.jasperreports6.engine.JRPropertiesHolder} interface.
 * <h3>Report Styles</h3>
 ...
 * {@link net.sf.jasperreports6.engine.JRDefaultStyleProvider#getDefaultStyle() getDefaultStyle()} method inherited from the 
 * {@link net.sf.jasperreports6.engine.JRDefaultStyleProvider} interface.
 * </p>
 * @see net.sf.jasperreports6.engine.JRParameter#IS_IGNORE_PAGINATION
 * @see net.sf.jasperreports6.engine.JRParameter#REPORT_RESOURCE_BUNDLE
 * @see net.sf.jasperreports6.engine.JRParameter#REPORT_SCRIPTLET
 * @see net.sf.jasperreports6.engine.JRPropertiesMap
 * @see net.sf.jasperreports6.engine.JRStyle
 * @see net.sf.jasperreports6.engine.util.DefaultFormatFactory
 * @see net.sf.jasperreports6.engine.util.FormatFactory
...
public interface JRReport extends JRDefaultStyleProvider, JRPropertiesHolder, JRIdentifiable
{
	...
	/**
	 * Gets the name of the class implementing the {@link net.sf.jasperreports6.engine.util.FormatFactory FormatFactory}
