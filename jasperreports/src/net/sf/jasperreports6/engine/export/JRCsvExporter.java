...
import net.sf.jasperreports6.export.CsvExporterConfiguration;
import net.sf.jasperreports6.export.CsvReportConfiguration;
 ...
 * the {@link net.sf.jasperreports6.engine.export.JRCsvExporter} is a grid exporter 
 ...
 * {@link net.sf.jasperreports6.export.CsvExporterConfiguration} class:
 * <ul>
 * <li>{@link net.sf.jasperreports6.export.CsvExporterConfiguration#getFieldDelimiter() getFieldDelimiter()}</li>
 * <li>{@link net.sf.jasperreports6.export.CsvExporterConfiguration#getRecordDelimiter() getRecordDelimiter()}</li>
 * <ul>
 * which both provide <code>java.lang.String</code> values.
 * 
 * @see net.sf.jasperreports6.export.CsvExporterConfiguration
