...
import net.sf.jasperreports6.engine.util.JRStringUtil;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.XlsExporterConfiguration;
import net.sf.jasperreports6.export.XlsReportConfiguration;
 ...
 * {@link net.sf.jasperreports6.engine.export.JRXlsExporter} implementation, which
 ...
 * {@link net.sf.jasperreports6.engine.export.ooxml.JRXlsxExporter}; it does not rely
 ...
 * to put all pages inside the source {@link net.sf.jasperreports6.engine.JasperPrint} document 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#isOnePagePerSheet() isOnePagePerSheet()}
 * exporter configuration setting, which is set to <code>Boolean.FALSE</code> by default.
 * <p/>
 * When {@link net.sf.jasperreports6.export.XlsReportConfiguration#isOnePagePerSheet() isOnePagePerSheet()} 
 ...
 * of rows per sheet for {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_MAXIMUM_ROWS_PER_SHEET net.sf.jasperreports.export.xls.max.rows.per.sheet} property and
 * set true for {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_ONE_PAGE_PER_SHEET net.sf.jasperreports.export.xls.one.page.per.sheet} property.
 * <p/>
 * The JasperReports Excel exporters provide a simple but efficient sheet-naming
 * mechanism. They use the {@link net.sf.jasperreports6.export.XlsReportConfiguration#getSheetNames() getSheetNames()} 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#isRemoveEmptySpaceBetweenRows() isRemoveEmptySpaceBetweenRows()} 
 ...
 * {@link net.sf.jasperreports6.engine.JRParameter#IS_IGNORE_PAGINATION IS_IGNORE_PAGINATION}.
 * You can modify the API to remove the empty space between rows and columns as well.
 * You need to set {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_ROWS net.sf.jasperreports.export.xls.remove.empty.space.between.rows}
 * property and/or {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_COLUMNS net.sf.jasperreports.export.xls.remove.empty.space.between.columns}
 * property to true.
 * <p/>
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_ROWS net.sf.jasperreports.export.xls.remove.empty.space.between.rows} property and/or
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_COLUMNS net.sf.jasperreports.export.xls.remove.empty.space.between.columns} property to
 * true, the empty spaces are removed.
 * <h3>Cell Types</h3>
 * Inside the proprietary document format that JasperReports uses (represented by the
 * {@link net.sf.jasperreports6.engine.JasperPrint} object), all text elements are 
 ...
 * the text elements inside the {@link net.sf.jasperreports6.engine.JasperPrint} object 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#isDetectCellType() isDetectCellType()} 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_DETECT_CELL_TYPE net.sf.jasperreports.export.xls.detect.cell.type} property to true. When you do this, instead
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#getFormatPatternsMap() getFormatPatternsMap()} 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#isFontSizeFixEnabled() isFontSizeFixEnabled()} 
 * exporter configuration flag to decrease the font size by one point when generating the cell format.
 * Alternatively, one can use the {@link net.sf.jasperreports6.export.XlsReportConfiguration#PROPERTY_FONT_SIZE_FIX_ENABLED net.sf.jasperreports.export.xls.font.size.fix.enabled}
 * property at report level.
 * <h3>Background Color</h3>
 * Empty space found on each page in the source {@link net.sf.jasperreports6.engine.JasperPrint} 
 ...
 * to be white, set the 
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration#isWhitePageBackground() isWhitePageBackground()} 
 ...
 * {@link net.sf.jasperreports6.export.XlsExporterConfiguration#isCreateCustomPalette() isCreateCustomPalette()} 
 ...
 * {@link net.sf.jasperreports6.export.XlsReportConfiguration} and 
 * {@link net.sf.jasperreports6.export.XlsExporterConfiguration} classes.
 * 
 * @see net.sf.jasperreports6.export.XlsExporterConfiguration
 * @see net.sf.jasperreports6.export.XlsReportConfiguration
