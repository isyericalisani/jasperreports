...
import net.sf.jasperreports6.engine.JRStyledTextAttributeSelector;
		...
		extends JRAbstractExporter<RC, C, OutputStreamExporterOutput, E> 
{
	...
	protected void ensureOutput() {
		if (exporterOutput == null) {
			exporterOutput = new net.sf.jasperreports6.export.parameters.ParametersOutputStreamExporterOutput(
