 ...
 * {@link net.sf.jasperreports6.engine.JasperExportManager JasperExportManager}; it can be used to obtain 
 * PDF, HTML, or XML content for the documents produced by the report-filling process. 
 * Exporting means taking a {@link net.sf.jasperreports6.engine.JasperPrint JasperPrint} object, 
 ...
 * </p><p>
 * The {@link net.sf.jasperreports6.engine.JasperExportManager JasperExportManager} class offers 
 ...
 * simple interface called {@link net.sf.jasperreports6.export.Exporter}. Every
 ...
 * {@link net.sf.jasperreports6.export.Exporter} interface, and this method does not 
 * receive any parameters when called. 
 * <p>
 * The input data for an exporter comes in the form of one or more 
 * {@link net.sf.jasperreports6.engine.JasperPrint} 
 ...
 * extend the {@link net.sf.jasperreports6.engine.JRAbstractExporter} class, which 
 ...
 * all we need is an {@link net.sf.jasperreports6.export.ExporterInput} instance that holds the necessary 
 * input data. This object must implement the <code>public List&lt;ExporterInputItem&gt; getItems()</code> 
 * method in order to obtain a list of {@link net.sf.jasperreports6.export.ExporterInputItem} objects. Each 
 * {@link net.sf.jasperreports6.export.ExporterInputItem} object in the list contains a single 
 * {@link net.sf.jasperreports6.engine.JasperPrint} object along with its related export 
 ...
 * {@link net.sf.jasperreports6.export.ExporterOutput} setting to see whether it needs to 
 ...
 * {@link net.sf.jasperreports6.engine.JRAbstractExporter} parent class. The <code>exporterOutput</code> 
 * argument must be an instance of {@link net.sf.jasperreports6.export.ExporterOutput} interface. 
 * </p>
 ...
 * {@link net.sf.jasperreports6.engine.JRAbstractExporter} parent class. The first method accepts 
 * an {@link net.sf.jasperreports6.export.ExporterConfiguration} argument and applies settings per exporter. 
 * The second one accepts a {@link net.sf.jasperreports6.export.ReportExportConfiguration} and applies 
 ...
 * {@link net.sf.jasperreports6.export.ReportExportConfiguration} class:
 * <ul>
 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} document or a list with several such generated documents. Exporting 
 * multiple {@link net.sf.jasperreports6.engine.JasperPrint} objects to a single resulting document is called batch mode 
 * exporting. 
 * <p>
 * Not all exporters can work in batch mode, but those that do first look into the supplied 
 * exporter input values to see whether a <code>java.util.List</code> of {@link net.sf.jasperreports6.engine.JasperPrint} 
 ...
 * </p><p>
 * If the exporters act on a single document, then they check whether an in-memory {@link net.sf.jasperreports6.engine.JasperPrint} 
 * value is supplied to the exporter input data. If no such value is found for this setting, then the input for the 
 * exporter is a single {@link net.sf.jasperreports6.engine.JasperPrint} document to be loaded from an input stream, an URL, 
 ...
 * {@link net.sf.jasperreports6.export.ReportExportConfiguration}  
 * class) should be used to pass a filter object, which would be an instance of a class that 
 * implements the {@link net.sf.jasperreports6.engine.export.ExporterFilter} 
 ...
 * {@link net.sf.jasperreports6.engine.JRAbstractExporter#PROPERTY_DEFAULT_FILTER_FACTORY net.sf.jasperreports.engine.export.default.filter.factory}. 
 * </p><p>
 ...
 * so, a property named {@link net.sf.jasperreports6.engine.export.DefaultExporterFilterFactory#PROPERTY_EXPORTER_FILTER_FACTORY_PREFIX net.sf.jasperreports.engine.export.filter.factory.&lt;factory_name&gt;} has 
 * to be included in the <code>jasperreports.properties</code> file (or set at runtime via 
 * {@link net.sf.jasperreports6.engine.JRPropertiesUtil JRPropertiesUtil}). The factory name is an arbitrary suffix, and the property value should 
 * be the name of a class that implements 
 * {@link net.sf.jasperreports6.engine.export.ExporterFilterFactory ExporterFilterFactory}. The engine 
 ...
 * {@link net.sf.jasperreports6.engine.export.ExporterFilter}. This filter will be 
 ...
 * called {@link net.sf.jasperreports6.engine.export.JRExportProgressMonitor}. To 
 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} object. 
 * </p>
 ...
 * 
 * @see net.sf.jasperreports6.engine.JasperExportManager
 * @see net.sf.jasperreports6.engine.JasperPrint
 * @see net.sf.jasperreports6.engine.JRAbstractExporter
 * @see net.sf.jasperreports6.export.Exporter
 * @see net.sf.jasperreports6.export.ExporterConfiguration
 * @see net.sf.jasperreports6.export.ExporterInput
 * @see net.sf.jasperreports6.export.ExporterInputItem
 * @see net.sf.jasperreports6.export.ExporterOutput
 * @see net.sf.jasperreports6.export.ReportExportConfiguration
 */
