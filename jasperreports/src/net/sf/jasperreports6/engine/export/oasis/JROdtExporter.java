 ...
 */
package net.sf.jasperreports6.engine.export.oasis;
...
import net.sf.jasperreports6.export.OdtExporterConfiguration;
import net.sf.jasperreports6.export.OdtReportConfiguration;
 ...
 * {@link net.sf.jasperreports6.engine.export.oasis.JROdtExporter} class.
 * <p/>
 * Currently, there are the following special configurations that can be applied to an ODT
 * exporter instance (see {@link net.sf.jasperreports6.export.DocxReportConfiguration}) to customize 
 * its behavior:
 * <ul>
 ...
 * {@link net.sf.jasperreports6.export.OdtReportConfiguration#isFlexibleRowHeight() isFlexibleRowHeight()} 
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.OdtReportConfiguration#PROPERTY_ODT_FLEXIBLE_ROW_HEIGHT net.sf.jasperreports.export.odt.flexible.row.height}.</li>
 ...
 * {@link net.sf.jasperreports6.export.OdtReportConfiguration#isIgnoreHyperlink() isIgnoreHyperlink()} 
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.OdtReportConfiguration#PROPERTY_IGNORE_HYPERLINK net.sf.jasperreports.export.odt.ignore.hyperlink}</li>
 * </ul>
 * <p/>
 ...
 * font mappings.
 * 
 * @see net.sf.jasperreports6.export.OdtReportConfiguration
