...
import net.sf.jasperreports6.engine.JRParagraph;
...
import net.sf.jasperreports6.engine.PrintBookmark;
import net.sf.jasperreports6.engine.PrintPageFormat;
import net.sf.jasperreports6.engine.PrintPart;
import net.sf.jasperreports6.engine.PrintParts;
 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} object, but in XML format, instead 
 ...
 * object using the {@link net.sf.jasperreports6.engine.xml.JRPrintXmlLoader} utility class. 
 ...
 * into a {@link net.sf.jasperreports6.engine.JasperPrint} object that will look the same as the original one.
 * <p/>
 * The built-in viewers can display documents exported in JRPXML format because they
 * actually rely on the {@link net.sf.jasperreports6.engine.xml.JRPrintXmlLoader} to load the 
 * document back into a {@link net.sf.jasperreports6.engine.JasperPrint} object before 
 ...
 * {@link net.sf.jasperreports6.export.XmlExporterOutput#isEmbeddingImages() isEmbeddingImages()} 
 ...
 * @see net.sf.jasperreports6.engine.xml.JRPrintXmlLoader
...
//	protected Map fontsMap = new HashMap();
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new net.sf.jasperreports6.export.parameters.ParametersXmlExporterOutput(
