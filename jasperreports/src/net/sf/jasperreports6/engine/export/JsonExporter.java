...
import net.sf.jasperreports6.engine.util.PartsUtil;
...
import net.sf.jasperreports6.export.JsonExporterOutput;
import net.sf.jasperreports6.export.JsonReportConfiguration;
...
public class JsonExporter extends JRAbstractExporter<JsonReportConfiguration, JsonExporterConfiguration, JsonExporterOutput, JsonExporterContext>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new net.sf.jasperreports6.export.parameters.ParametersJsonExporterOutput(
	 ...
	 */
	public static void writeBookmarks(List<PrintBookmark> bookmarks, Writer writer, net.sf.jasperreports6.web.util.JacksonUtil jacksonUtil) throws IOException
	{
