...
import net.sf.jasperreports6.engine.JRAbstractExporter;
import net.sf.jasperreports6.engine.JRAnchor;
import net.sf.jasperreports6.engine.JRBoxContainer;
import net.sf.jasperreports6.engine.JRCommonGraphicElement;
...
import net.sf.jasperreports6.engine.JRLineBox;
import net.sf.jasperreports6.engine.JRPen;
import net.sf.jasperreports6.engine.JRPrintAnchor;
import net.sf.jasperreports6.engine.JRPrintElement;
import net.sf.jasperreports6.engine.JRPrintEllipse;
import net.sf.jasperreports6.engine.JRPrintFrame;
import net.sf.jasperreports6.engine.JRPrintHyperlink;
import net.sf.jasperreports6.engine.JRPrintImage;
import net.sf.jasperreports6.engine.JRPrintLine;
import net.sf.jasperreports6.engine.JRPrintPage;
import net.sf.jasperreports6.engine.JRPrintRectangle;
...
import net.sf.jasperreports6.engine.PrintPageFormat;
import net.sf.jasperreports6.engine.JRPropertiesUtil.PropertySuffix;
import net.sf.jasperreports6.engine.base.JRBaseFont;
import net.sf.jasperreports6.engine.base.JRBasePen;
import net.sf.jasperreports6.engine.base.JRBasePrintText;
import net.sf.jasperreports6.engine.export.type.PdfFieldBorderStyleEnum;
import net.sf.jasperreports6.engine.export.type.PdfFieldCheckTypeEnum;
import net.sf.jasperreports6.engine.export.type.PdfFieldTypeEnum;
import net.sf.jasperreports6.engine.fonts.FontFace;
import net.sf.jasperreports6.engine.fonts.FontFamily;
import net.sf.jasperreports6.engine.fonts.FontInfo;
import net.sf.jasperreports6.engine.fonts.FontUtil;
import net.sf.jasperreports6.engine.type.HyperlinkTypeEnum;
import net.sf.jasperreports6.engine.type.ImageTypeEnum;
import net.sf.jasperreports6.engine.type.LineDirectionEnum;
import net.sf.jasperreports6.engine.type.LineStyleEnum;
import net.sf.jasperreports6.engine.type.ModeEnum;
import net.sf.jasperreports6.engine.type.OrientationEnum;
import net.sf.jasperreports6.engine.util.ExifOrientationEnum;
import net.sf.jasperreports6.engine.util.ImageUtil;
import net.sf.jasperreports6.engine.util.JRPdfaIccProfileNotFoundException;
import net.sf.jasperreports6.engine.util.JRSingletonCache;
import net.sf.jasperreports6.engine.util.JRStyledText;
import net.sf.jasperreports6.engine.util.JRStyledTextUtil;
import net.sf.jasperreports6.engine.util.JRTextAttribute;
import net.sf.jasperreports6.engine.util.JRTypeSniffer;
import net.sf.jasperreports6.engine.util.Pair;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.OutputStreamExporterOutput;
import net.sf.jasperreports6.export.PdfExporterConfiguration;
import net.sf.jasperreports6.export.PdfReportConfiguration;
import net.sf.jasperreports6.export.pdf.FontRecipient;
import net.sf.jasperreports6.export.pdf.LineCapStyle;
import net.sf.jasperreports6.export.pdf.PdfChunk;
import net.sf.jasperreports6.export.pdf.PdfContent;
import net.sf.jasperreports6.export.pdf.PdfDocument;
import net.sf.jasperreports6.export.pdf.PdfDocumentWriter;
import net.sf.jasperreports6.export.pdf.PdfFontStyle;
import net.sf.jasperreports6.export.pdf.PdfImage;
import net.sf.jasperreports6.export.pdf.PdfOutlineEntry;
import net.sf.jasperreports6.export.pdf.PdfPhrase;
import net.sf.jasperreports6.export.pdf.PdfProducer;
import net.sf.jasperreports6.export.pdf.PdfProducerContext;
import net.sf.jasperreports6.export.pdf.PdfProducerFactory;
import net.sf.jasperreports6.export.pdf.PdfRadioCheck;
import net.sf.jasperreports6.export.pdf.PdfTextAlignment;
import net.sf.jasperreports6.export.pdf.PdfTextChunk;
import net.sf.jasperreports6.export.pdf.PdfTextField;
import net.sf.jasperreports6.export.pdf.PdfTextRendererContext;
import net.sf.jasperreports6.export.pdf.TextDirection;
import net.sf.jasperreports6.export.pdf.classic.ClassicPdfProducer;
import net.sf.jasperreports6.export.type.PdfPermissionsEnum;
import net.sf.jasperreports6.export.type.PdfPrintScalingEnum;
import net.sf.jasperreports6.export.type.PdfVersionEnum;
import net.sf.jasperreports6.export.type.PdfaConformanceEnum;
import net.sf.jasperreports6.properties.PropertyConstants;
import net.sf.jasperreports6.renderers.DataRenderable;
import net.sf.jasperreports6.renderers.DimensionRenderable;
import net.sf.jasperreports6.renderers.Graphics2DRenderable;
import net.sf.jasperreports6.renderers.Renderable;
import net.sf.jasperreports6.renderers.RenderersCache;
import net.sf.jasperreports6.renderers.ResourceRenderer;
import net.sf.jasperreports6.renderers.WrappingImageDataToGraphics2DRenderer;
import net.sf.jasperreports6.renderers.WrappingRenderToImageDataRenderer;
import net.sf.jasperreports6.renderers.WrappingSvgDataToGraphics2DRenderer;
import net.sf.jasperreports6.renderers.util.RendererUtil;
 ...
 * {@link net.sf.jasperreports6.engine.export.JRPdfExporter} class in JasperReports is
 * one of the best exporters. The output it produces is almost of the same quality as that
 * produced by the {@link net.sf.jasperreports6.engine.export.JRGraphics2DExporter},
 * which is always the reference.
 * <p/>
 * The {@link net.sf.jasperreports6.engine.export.JRPdfExporter} implementation uses OpenPDF, 
 ...
 * {@link net.sf.jasperreports6.engine.export.JRPdfExporter} internally acquires the needed PDF 
 ...
 * {@link net.sf.jasperreports6.export.PdfExporterConfiguration#isCreatingBatchModeBookmarks() isCreatingBatchModeBookmarks()}
 ...
 * There are five exporter configuration settings for this (see {@link net.sf.jasperreports6.export.PdfExporterConfiguration}):
 * <ul>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#isEncrypted() isEncrypted()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#is128BitKey() is128BitKey()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getUserPassword() getUserPassword()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getOwnerPassword() getOwnerPassword()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getPermissions() getPermissions()}</li>
 * </ul>
 ...
 * (see {@link net.sf.jasperreports6.export.PdfExporterConfiguration}):
 * <ul>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getPdfVersion() getPdfVersion()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#isCompressed() isCompressed()}</li>
 * </ul>
 ...
 * on using the {@link net.sf.jasperreports6.export.PdfExporterConfiguration#isCompressed() isCompressed()} 
 ...
 * {@link net.sf.jasperreports6.export.PdfReportConfiguration#isForceLineBreakPolicy() isForceLineBreakPolicy()} 
 ...
 * {@link net.sf.jasperreports6.export.PdfReportConfiguration#PROPERTY_FORCE_LINEBREAK_POLICY net.sf.jasperreports.export.pdf.force.linebreak.policy} configuration
 * property
 ...
 * {@link net.sf.jasperreports6.export.PdfExporterConfiguration#getPdfJavaScript() getPdfJavaScript()} 
 ...
 * configuration settings available in the {@link net.sf.jasperreports6.export.PdfExporterConfiguration}
 * class. They are all listed following:
 * <ul>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getMetadataAuthor() getMetadataAuthor()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getMetadataCreator() getMetadataCreator()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getMetadataKeywords() getMetadataKeywords()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getMetadataSubject() getMetadataSubject()}</li>
 * <li>{@link net.sf.jasperreports6.export.PdfExporterConfiguration#getMetadataTitle() getMetadataTitle()}</li>
 * </ul>
 * <h3>Rendering SVG Using Shapes</h3>
 * The {@link net.sf.jasperreports6.export.PdfReportConfiguration#isForceSvgShapes() isForceSvgShapes()} 
 ...
 * {@link net.sf.jasperreports6.renderers.Renderable} implementations,
 * which are most likely subclasses of the {@link net.sf.jasperreports6.renderers.AbstractRenderToImageDataRenderer} 
 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.engine.util.JRTextAttribute#PDF_FONT_NAME PDF_FONT_NAME}</li>
 * <li>{@link net.sf.jasperreports6.engine.util.JRTextAttribute#PDF_ENCODING PDF_ENCODING}</li>
 * <li>{@link net.sf.jasperreports6.engine.util.JRTextAttribute#IS_PDF_EMBEDDED IS_PDF_EMBEDDED}</li>
 * </ul>
 * <p/>
 ...
 * {@link net.sf.jasperreports6.export.PdfReportConfiguration#PROPERTY_FORCE_SVG_SHAPES net.sf.jasperreports.export.pdf.force.svg.shapes} configuration property.
 * The {@link net.sf.jasperreports6.export.PdfReportConfiguration#isForceSvgShapes() isForceSvgShapes()} 
 ...
 * <ul>
 * <li>setting to true the {@link net.sf.jasperreports6.export.PdfExporterConfiguration#isTagged() isTagged()}
 * configuration flag</li>
 * <li>setting to true the {@link net.sf.jasperreports6.export.PdfExporterConfiguration#PROPERTY_TAGGED net.sf.jasperreports.export.pdf.tagged} configuration property.</li>
 * </ul>
 ...
 * <ul>
 * <li>using the {@link net.sf.jasperreports6.export.PdfExporterConfiguration#getTagLanguage() getTagLanguage()}
 * configuration setting to retrieve the language as a <code>java.lang.String</code> value;</li>
 * <li>using the {@link net.sf.jasperreports6.export.PdfExporterConfiguration#PROPERTY_TAG_LANGUAGE net.sf.jasperreports.export.pdf.tag.language} configuration property 
 ...
 * please consult the {@link net.sf.jasperreports6.engine.export.JRPdfExporterTagHelper} class.
 * 
 * @see net.sf.jasperreports6.export.PdfExporterConfiguration
 * @see net.sf.jasperreports6.export.PdfReportConfiguration
 * @see net.sf.jasperreports6.engine.util.JRTextAttribute#IS_PDF_EMBEDDED
 * @see net.sf.jasperreports6.engine.util.JRTextAttribute#PDF_ENCODING
 * @see net.sf.jasperreports6.engine.util.JRTextAttribute#PDF_FONT_NAME
...
public class JRPdfExporter extends JRAbstractExporter<PdfReportConfiguration, PdfExporterConfiguration, OutputStreamExporterOutput, JRPdfExporterContext>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new net.sf.jasperreports6.export.parameters.ParametersOutputStreamExporterOutput(
