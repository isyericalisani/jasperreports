...
import net.sf.jasperreports6.engine.JRPrintImageArea;
import net.sf.jasperreports6.engine.JRPrintImageAreaHyperlink;
...
import net.sf.jasperreports6.engine.PrintElementId;
...
import net.sf.jasperreports6.engine.export.tabulator.Cell;
import net.sf.jasperreports6.engine.export.tabulator.CellVisitor;
import net.sf.jasperreports6.engine.export.tabulator.Column;
import net.sf.jasperreports6.engine.export.tabulator.ElementCell;
import net.sf.jasperreports6.engine.export.tabulator.FrameCell;
import net.sf.jasperreports6.engine.export.tabulator.LayeredCell;
import net.sf.jasperreports6.engine.export.tabulator.NestedTableCell;
import net.sf.jasperreports6.engine.export.tabulator.Row;
import net.sf.jasperreports6.engine.export.tabulator.SplitCell;
import net.sf.jasperreports6.engine.export.tabulator.Table;
import net.sf.jasperreports6.engine.export.tabulator.TableCell;
import net.sf.jasperreports6.engine.export.tabulator.TablePosition;
import net.sf.jasperreports6.engine.export.tabulator.Tabulator;
import net.sf.jasperreports6.engine.export.tabulator.TableCell.CellType;
import net.sf.jasperreports6.engine.type.HorizontalImageAlignEnum;
...
import net.sf.jasperreports6.engine.type.VerticalImageAlignEnum;
import net.sf.jasperreports6.engine.util.ExifOrientationEnum;
import net.sf.jasperreports6.engine.util.HyperlinkData;
...
import net.sf.jasperreports6.engine.util.StyledTextListWriter;
import net.sf.jasperreports6.engine.util.StyledTextWriteContext;
import net.sf.jasperreports6.export.AccessibilityUtil;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.HtmlExporterConfiguration;
import net.sf.jasperreports6.export.HtmlReportConfiguration;
import net.sf.jasperreports6.export.type.AccessibilityTagEnum;
import net.sf.jasperreports6.export.type.HtmlBorderCollapseEnum;
import net.sf.jasperreports6.properties.PropertyConstants;
import net.sf.jasperreports6.renderers.AreaHyperlinksRenderable;
...
import net.sf.jasperreports6.renderers.util.SvgDataSniffer;
import net.sf.jasperreports6.renderers.util.SvgFontProcessor;
import net.sf.jasperreports6.search.HitTermInfo;
import net.sf.jasperreports6.search.SpansInfo;
import net.sf.jasperreports6.util.Base64Util;
...
public class HtmlExporter extends AbstractHtmlExporter<HtmlReportConfiguration, HtmlExporterConfiguration>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new net.sf.jasperreports6.export.parameters.ParametersHtmlExporterOutput(
