...
import net.sf.jasperreports6.export.RtfExporterConfiguration;
import net.sf.jasperreports6.export.RtfReportConfiguration;
 ...
 * <p/>
 * The {@link net.sf.jasperreports6.engine.export.JRRtfExporter} implementation helps
 ...
 * and PDF exporters. The {@link net.sf.jasperreports6.export.RtfReportConfiguration} provides special 
 * configuration settings for this exporter.
 * <p/>
 * Almost all the provided samples show how to export to RTF.
 * 
 * @see net.sf.jasperreports6.export.RtfReportConfiguration
...
public class JRRtfExporter extends JRAbstractExporter<RtfReportConfiguration, RtfExporterConfiguration, WriterExporterOutput, JRRtfExporterContext>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new net.sf.jasperreports6.export.parameters.ParametersWriterExporterOutput(
