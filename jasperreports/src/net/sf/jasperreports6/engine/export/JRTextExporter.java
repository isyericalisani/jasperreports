...
import net.sf.jasperreports6.export.TextExporterConfiguration;
import net.sf.jasperreports6.export.TextReportConfiguration;
 ...
 * (see {@link net.sf.jasperreports6.export.TextReportConfiguration}):
 * <ul>
 * <li>{@link net.sf.jasperreports6.export.TextReportConfiguration#getCharWidth() getCharWidth()} and 
 * {@link net.sf.jasperreports6.export.TextReportConfiguration#getCharHeight() getCharHeight()} - 
 * these specify how many pixels in the original report should be mapped onto a character in the exported text.</li>
 * <li>{@link net.sf.jasperreports6.export.TextReportConfiguration#getPageWidthInChars() getPageWidthInChars()} and 
 * {@link net.sf.jasperreports6.export.TextReportConfiguration#getPageHeightInChars() getPageHeightInChars()} - 
 ...
 * the {@link net.sf.jasperreports6.export.TextExporterConfiguration#getPageSeparator() getPageSeparator()} 
 ...
 * {@link net.sf.jasperreports6.export.TextExporterConfiguration#getLineSeparator() getLineSeparator()} 
 ...
 * can produce.
 * 
 * @see net.sf.jasperreports6.export.TextExporterConfiguration
 * @see net.sf.jasperreports6.export.TextReportConfiguration
