...
import net.sf.jasperreports6.engine.export.zip.FileBufferedZip;
...
//		stylesEntry = createEntry("xl/styles.xml");
		...
		addEntry("_rels/.rels", "net/sf/jasperreports6/engine/export/ooxml/pptx/_rels/xml.rels");
		addEntry("ppt/slideLayouts/_rels/slideLayout1.xml.rels", "net/sf/jasperreports6/engine/export/ooxml/pptx/ppt/slideLayouts/_rels/slideLayout1.xml.rels");
		addEntry("ppt/slideLayouts/slideLayout1.xml", "net/sf/jasperreports6/engine/export/ooxml/pptx/ppt/slideLayouts/slideLayout1.xml");
		addEntry("ppt/theme/theme1.xml", "net/sf/jasperreports6/engine/export/ooxml/pptx/ppt/theme/theme1.xml");
		addEntry("ppt/tableStyles.xml", "net/sf/jasperreports6/engine/export/ooxml/pptx/ppt/tableStyles.xml");
	}
