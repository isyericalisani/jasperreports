 ...
 */
package net.sf.jasperreports6.engine.export.ooxml;
...
import net.sf.jasperreports6.engine.JRPrintElementIndex;
...
import net.sf.jasperreports6.engine.base.JRBaseLineBox;
import net.sf.jasperreports6.engine.export.CutsInfo;
import net.sf.jasperreports6.engine.export.ElementGridCell;
import net.sf.jasperreports6.engine.export.ExporterFilter;
import net.sf.jasperreports6.engine.export.ExporterNature;
import net.sf.jasperreports6.engine.export.GenericElementHandlerEnviroment;
import net.sf.jasperreports6.engine.export.Grid;
import net.sf.jasperreports6.engine.export.GridRow;
import net.sf.jasperreports6.engine.export.HyperlinkUtil;
import net.sf.jasperreports6.engine.export.JRExportProgressMonitor;
import net.sf.jasperreports6.engine.export.JRExporterGridCell;
import net.sf.jasperreports6.engine.export.JRGridLayout;
import net.sf.jasperreports6.engine.export.JRHyperlinkProducer;
import net.sf.jasperreports6.engine.export.JRXmlExporter;
import net.sf.jasperreports6.engine.export.LengthUtil;
import net.sf.jasperreports6.engine.export.OccupiedGridCell;
import net.sf.jasperreports6.engine.export.zip.ExportZipEntry;
import net.sf.jasperreports6.engine.export.zip.FileBufferedZipEntry;
...
import net.sf.jasperreports6.engine.util.StyledTextWriteContext;
import net.sf.jasperreports6.engine.util.ImageUtil.Insets;
import net.sf.jasperreports6.export.DocxExporterConfiguration;
import net.sf.jasperreports6.export.DocxReportConfiguration;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.OutputStreamExporterOutput;
import net.sf.jasperreports6.export.PrintPartUnrollExporterInput;
import net.sf.jasperreports6.export.ReportExportConfiguration;
 ...
 * exporter instance (see {@link net.sf.jasperreports6.export.DocxReportConfiguration}):
 * <ul>
 * <li>Forcing the use of nested tables to render the content of frame elements using either
 * the {@link net.sf.jasperreports6.export.DocxReportConfiguration#isFramesAsNestedTables() isFramesAsNestedTables()} 
 * exporter configuration flag or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.DocxReportConfiguration#PROPERTY_FRAMES_AS_NESTED_TABLES net.sf.jasperreports.export.docx.frames.as.nested.tables}.</li>
 ...
 * {@link net.sf.jasperreports6.export.DocxReportConfiguration#isFlexibleRowHeight() isFlexibleRowHeight()} 
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.DocxReportConfiguration#PROPERTY_FLEXIBLE_ROW_HEIGHT net.sf.jasperreports.export.docx.flexible.row.height}.</li>
 ...
 * {@link net.sf.jasperreports6.export.DocxReportConfiguration#isIgnoreHyperlink() isIgnoreHyperlink()} 
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.DocxReportConfiguration#PROPERTY_IGNORE_HYPERLINK net.sf.jasperreports.export.docx.ignore.hyperlink}</li>
 * </ul>
 * 
 * @see net.sf.jasperreports6.export.DocxReportConfiguration
