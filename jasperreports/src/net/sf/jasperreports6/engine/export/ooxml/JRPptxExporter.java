...
import net.sf.jasperreports6.engine.export.ooxml.type.PptxFieldTypeEnum;
...
import net.sf.jasperreports6.engine.util.FileBufferedWriter;
...
import net.sf.jasperreports6.export.PptxExporterConfiguration;
import net.sf.jasperreports6.export.PptxReportConfiguration;
 ...
 * exporter instance (see {@link net.sf.jasperreports6.export.PptxReportConfiguration})
 ...
 * {@link net.sf.jasperreports6.export.PptxReportConfiguration#isIgnoreHyperlink() isIgnoreHyperlink()} 
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link net.sf.jasperreports6.export.PptxReportConfiguration#PROPERTY_IGNORE_HYPERLINK net.sf.jasperreports.export.pptx.ignore.hyperlink}.
 * <p/>
 ...
 * defined.
 * 
 * @see net.sf.jasperreports6.export.PptxReportConfiguration
...
//		styleHelper.close();
		...
		for (reportIndex = 0; reportIndex < items.size(); reportIndex++)
		{
			...
			if (pages != null && pages.size() > 0)
			{
				...
				net.sf.jasperreports6.engine.util.PageRange[] hideSmPageRanges = null;
				...
				{
					hideSmPageRanges = net.sf.jasperreports6.engine.util.PageRange.parse(hideSlideMasterPages);
				}
				...
				for (pageIndex = startPageIndex; pageIndex <= endPageIndex; pageIndex++)
				{
					...
					createSlide(net.sf.jasperreports6.engine.util.PageRange.isPageInRanges(pageIndex + 1, hideSmPageRanges));
