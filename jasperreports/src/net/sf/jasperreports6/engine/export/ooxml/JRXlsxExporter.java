...
import net.sf.jasperreports6.engine.export.Cut;
...
import net.sf.jasperreports6.engine.export.JRXlsAbstractExporter;
import net.sf.jasperreports6.engine.export.LengthUtil;
import net.sf.jasperreports6.engine.export.OccupiedGridCell;
import net.sf.jasperreports6.engine.export.XlsRowLevelInfo;
import net.sf.jasperreports6.engine.export.data.BooleanTextValue;
import net.sf.jasperreports6.engine.export.data.DateTextValue;
import net.sf.jasperreports6.engine.export.data.NumberTextValue;
import net.sf.jasperreports6.engine.export.data.StringTextValue;
import net.sf.jasperreports6.engine.export.data.TextValue;
import net.sf.jasperreports6.engine.export.data.TextValueHandler;
import net.sf.jasperreports6.engine.export.type.ImageAnchorTypeEnum;
...
import net.sf.jasperreports6.engine.util.DefaultFormatFactory;
import net.sf.jasperreports6.engine.util.ExifOrientationEnum;
import net.sf.jasperreports6.engine.util.FileBufferedOutputStream;
...
import net.sf.jasperreports6.export.ExporterInput;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.XlsReportConfiguration;
import net.sf.jasperreports6.export.XlsxExporterConfiguration;
import net.sf.jasperreports6.export.XlsxReportConfiguration;
 ...
 * grid-based layout.
 * 
 * @see net.sf.jasperreports6.engine.export.JRXlsAbstractExporter
