...
import net.sf.jasperreports6.engine.export.draw.FrameDrawer;
import net.sf.jasperreports6.engine.export.draw.PrintDrawVisitor;
import net.sf.jasperreports6.engine.util.JRGraphEnvInitializer;
import net.sf.jasperreports6.export.Graphics2DExporterConfiguration;
import net.sf.jasperreports6.export.Graphics2DExporterOutput;
import net.sf.jasperreports6.export.Graphics2DReportConfiguration;
 ...
 * {@link net.sf.jasperreports6.engine.export.JRGraphics2DExporter} is the perfect
 ...
 * {@link net.sf.jasperreports6.export.SimpleExporterInput} instance, the exporter 
 ...
 * {@link net.sf.jasperreports6.export.ReportExportConfiguration#getStartPageIndex() getStartPageIndex()}
 * exporter configuration setting or the
 * {@link net.sf.jasperreports6.export.ReportExportConfiguration#getPageIndex() getPageIndex()}.
 * Note that if present, {@link net.sf.jasperreports6.export.ReportExportConfiguration#getPageIndex() getPageIndex()} overrides the value of
 * {@link net.sf.jasperreports6.export.ReportExportConfiguration#getStartPageIndex() getStartPageIndex()}. 
 ...
 * exporter output setting {@link net.sf.jasperreports6.export.Graphics2DExporterOutput#getGraphics2D() getGraphics2D()}. 
 ...
 * {@link net.sf.jasperreports6.export.Graphics2DReportConfiguration#getZoomRatio() getZoomRatio()} export 
 ...
 * {@link net.sf.jasperreports6.export.Graphics2DReportConfiguration#isMinimizePrinterJobSize() isMinimizePrinterJobSize()} 
 ...
 * 
 * @see net.sf.jasperreports6.export.Graphics2DExporterOutput
 * @see net.sf.jasperreports6.export.Graphics2DReportConfiguration
 * @see net.sf.jasperreports6.export.ReportExportConfiguration
 * @see net.sf.jasperreports6.export.SimpleExporterInput
...
public class JRGraphics2DExporter extends JRAbstractExporter<Graphics2DReportConfiguration, Graphics2DExporterConfiguration, Graphics2DExporterOutput, JRGraphics2DExporterContext>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = new net.sf.jasperreports6.export.parameters.ParametersGraphics2DExporterOutput(parameters);
		}
	}
