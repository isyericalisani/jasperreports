...
import net.sf.jasperreports6.engine.print.JRPrinterAWT;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.ExporterOutput;
import net.sf.jasperreports6.export.PrintServiceExporterConfiguration;
import net.sf.jasperreports6.export.PrintServiceReportConfiguration;
 ...
 * </ul>
 * <p/>
 * The {@link net.sf.jasperreports6.engine.export.JRPrintServiceExporter}
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#getPrintServiceAttributeSet() getPrintServiceAttributeSet()} 
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#getPrintService() getPrintService()} 
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#getPrintRequestAttributeSet() getPrintRequestAttributeSet()} 
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPageDialog() isDisplayPageDialog()}
 * and
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPrintDialog() isDisplayPrintDialog()}, 
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPageDialog() isDisplayPageDialog()} or 
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPrintDialog() isDisplayPrintDialog()} are
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPageDialogOnlyOnce() isDisplayPageDialogOnlyOnce()} and 
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPrintDialogOnlyOnce() isDisplayPrintDialogOnlyOnce()}. These
 * are only effective if the corresponding 
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPageDialog() isDisplayPageDialog()} or 
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPrintDialog() isDisplayPrintDialog()} are
 * set to true.
 * <p/>
 * If {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPageDialogOnlyOnce() isDisplayPageDialogOnlyOnce()}
 ...
 * {@link net.sf.jasperreports6.export.PrintServiceExporterConfiguration#isDisplayPrintDialogOnlyOnce() isDisplayPrintDialogOnlyOnce()}
 ...
 * }</pre>
 * 
 * @see net.sf.jasperreports6.export.PrintServiceExporterConfiguration
