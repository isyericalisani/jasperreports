...
import net.sf.jasperreports6.engine.export.DefaultHyperlinkProducerFactory;
import net.sf.jasperreports6.engine.export.ExporterFilter;
import net.sf.jasperreports6.engine.export.ExporterFilterFactory;
import net.sf.jasperreports6.engine.export.ExporterFilterFactoryUtil;
import net.sf.jasperreports6.engine.export.JRExporterContext;
import net.sf.jasperreports6.engine.export.JRHyperlinkProducer;
import net.sf.jasperreports6.engine.export.JRHyperlinkProducerFactory;
...
import net.sf.jasperreports6.engine.util.FormatFactory;
...
import net.sf.jasperreports6.engine.util.JRStyledTextParser;
import net.sf.jasperreports6.engine.util.JRStyledTextUtil;
import net.sf.jasperreports6.engine.util.Pair;
import net.sf.jasperreports6.export.CompositeExporterConfigurationFactory;
import net.sf.jasperreports6.export.ExportInterruptedException;
import net.sf.jasperreports6.export.Exporter;
import net.sf.jasperreports6.export.ExporterConfiguration;
import net.sf.jasperreports6.export.ExporterInput;
import net.sf.jasperreports6.export.ExporterInputItem;
import net.sf.jasperreports6.export.ExporterOutput;
import net.sf.jasperreports6.export.PropertiesDefaultsConfigurationFactory;
import net.sf.jasperreports6.export.PropertiesNoDefaultsConfigurationFactory;
...
import net.sf.jasperreports6.repo.RepositoryResourceContext;
import net.sf.jasperreports6.repo.RepositoryUtil;
import net.sf.jasperreports6.repo.SimpleRepositoryContext;
...
public abstract class JRAbstractExporter<RC extends ReportExportConfiguration, C extends ExporterConfiguration, O extends ExporterOutput, E extends JRExporterContext> implements JRExporter<ExporterInput, RC, C, O>
{
	 ...
	 */
	@Property(
			name = "net.sf.jasperreports6.export.{arbitrary_name}.default.filter.factory",
	...
	@Property(
			category = PropertyConstants.CATEGORY_EXPORT,
			valueType = Class.class,
			defaultValue = "net.sf.jasperreports6.engine.export.DefaultExporterFilterFactory",
	...
	protected void ensureJasperReportsContext()
	{
		...
		{
			net.sf.jasperreports6.engine.util.LocalJasperReportsContext localJasperReportsContext = 
				new net.sf.jasperreports6.engine.util.LocalJasperReportsContext(jasperReportsContext);
	...
	protected RC getCurrentItemConfiguration()
	{
		if (crtCompositeItemConfiguration == null)
		{
			...
			if (useOldApi)
			{
				@SuppressWarnings("deprecation")
				RC depConf = 
					new net.sf.jasperreports6.export.parameters.ParametersExporterConfigurationFactory<RC>(
	...
	protected C getCurrentConfiguration()
	{
		if (crtCompositeConfiguration == null)
		{
			if (useOldApi)
			{
				@SuppressWarnings("deprecation")
				C depConf = 
					new net.sf.jasperreports6.export.parameters.ParametersExporterConfigurationFactory<C>(
						getJasperReportsContext(),
						getParameters(),
						getCurrentJasperPrint()
						).getConfiguration(
	...
	protected void ensureInput()
	{
		...
		{
			exporterInput = new net.sf.jasperreports6.export.parameters.ParametersExporterInput(parameters);
		}
