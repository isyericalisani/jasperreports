 ...
 * {@link net.sf.jasperreports6.engine.JasperPrint} objects. 
 * <p>
 * Generated documents can be stored in XML format if they are exported using the
 * {@link net.sf.jasperreports6.engine.export.JRXmlExporter}. After they're exported,
 * one can parse them back into {@link net.sf.jasperreports6.engine.JasperPrint} objects
 * by using this class.
 * </p>
