...
import net.sf.jasperreports6.charts.design.JRDesignCategorySeries;
import net.sf.jasperreports6.charts.design.JRDesignDataRange;
import net.sf.jasperreports6.charts.design.JRDesignGanttSeries;
import net.sf.jasperreports6.charts.design.JRDesignItemLabel;
import net.sf.jasperreports6.charts.design.JRDesignPieSeries;
import net.sf.jasperreports6.charts.design.JRDesignTimePeriodSeries;
import net.sf.jasperreports6.charts.design.JRDesignTimeSeries;
import net.sf.jasperreports6.charts.design.JRDesignValueDisplay;
import net.sf.jasperreports6.charts.design.JRDesignXySeries;
import net.sf.jasperreports6.charts.design.JRDesignXyzSeries;
import net.sf.jasperreports6.charts.util.JRAxisFormat;
import net.sf.jasperreports6.charts.util.JRMeterInterval;
import net.sf.jasperreports6.charts.xml.JRAreaChartFactory;
import net.sf.jasperreports6.charts.xml.JRAreaPlotFactory;
import net.sf.jasperreports6.charts.xml.JRBar3DChartFactory;
import net.sf.jasperreports6.charts.xml.JRBar3DPlotFactory;
import net.sf.jasperreports6.charts.xml.JRBarChartFactory;
import net.sf.jasperreports6.charts.xml.JRBarPlotFactory;
import net.sf.jasperreports6.charts.xml.JRBubbleChartFactory;
import net.sf.jasperreports6.charts.xml.JRBubblePlotFactory;
import net.sf.jasperreports6.charts.xml.JRCandlestickChartFactory;
import net.sf.jasperreports6.charts.xml.JRCandlestickPlotFactory;
import net.sf.jasperreports6.charts.xml.JRCategoryDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRCategorySeriesFactory;
import net.sf.jasperreports6.charts.xml.JRChartAxisFactory;
import net.sf.jasperreports6.charts.xml.JRDataRangeFactory;
import net.sf.jasperreports6.charts.xml.JRGanttChartFactory;
import net.sf.jasperreports6.charts.xml.JRGanttDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRGanttSeriesFactory;
import net.sf.jasperreports6.charts.xml.JRHighLowChartFactory;
import net.sf.jasperreports6.charts.xml.JRHighLowDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRHighLowPlotFactory;
import net.sf.jasperreports6.charts.xml.JRItemLabelFactory;
import net.sf.jasperreports6.charts.xml.JRLineChartFactory;
import net.sf.jasperreports6.charts.xml.JRLinePlotFactory;
import net.sf.jasperreports6.charts.xml.JRMeterChartFactory;
import net.sf.jasperreports6.charts.xml.JRMeterIntervalFactory;
import net.sf.jasperreports6.charts.xml.JRMeterPlotFactory;
import net.sf.jasperreports6.charts.xml.JRMultiAxisChartFactory;
import net.sf.jasperreports6.charts.xml.JRMultiAxisPlotFactory;
import net.sf.jasperreports6.charts.xml.JRPie3DChartFactory;
import net.sf.jasperreports6.charts.xml.JRPie3DPlotFactory;
import net.sf.jasperreports6.charts.xml.JRPieChartFactory;
import net.sf.jasperreports6.charts.xml.JRPieDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRPiePlotFactory;
import net.sf.jasperreports6.charts.xml.JRPieSeriesFactory;
import net.sf.jasperreports6.charts.xml.JRScatterChartFactory;
import net.sf.jasperreports6.charts.xml.JRScatterPlotFactory;
import net.sf.jasperreports6.charts.xml.JRStackedAreaChartFactory;
import net.sf.jasperreports6.charts.xml.JRStackedBar3DChartFactory;
import net.sf.jasperreports6.charts.xml.JRStackedBarChartFactory;
import net.sf.jasperreports6.charts.xml.JRThermometerChartFactory;
import net.sf.jasperreports6.charts.xml.JRThermometerPlotFactory;
import net.sf.jasperreports6.charts.xml.JRTimePeriodDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRTimePeriodSeriesFactory;
import net.sf.jasperreports6.charts.xml.JRTimeSeriesChartFactory;
import net.sf.jasperreports6.charts.xml.JRTimeSeriesDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRTimeSeriesFactory;
import net.sf.jasperreports6.charts.xml.JRTimeSeriesPlotFactory;
import net.sf.jasperreports6.charts.xml.JRValueDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRValueDisplayFactory;
import net.sf.jasperreports6.charts.xml.JRXyAreaChartFactory;
import net.sf.jasperreports6.charts.xml.JRXyBarChartFactory;
import net.sf.jasperreports6.charts.xml.JRXyDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRXyLineChartFactory;
import net.sf.jasperreports6.charts.xml.JRXySeriesFactory;
import net.sf.jasperreports6.charts.xml.JRXyzDatasetFactory;
import net.sf.jasperreports6.charts.xml.JRXyzSeriesFactory;
import net.sf.jasperreports6.crosstabs.JRCrosstabParameter;
import net.sf.jasperreports6.crosstabs.design.DesignCrosstabColumnCell;
...
import net.sf.jasperreports6.crosstabs.design.JRDesignCrosstabRowGroup;
import net.sf.jasperreports6.crosstabs.type.CrosstabColumnPositionEnum;
import net.sf.jasperreports6.crosstabs.xml.JRCellContentsFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabBucketExpressionFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabBucketFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabCellFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabColumnGroupFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabDatasetFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabMeasureFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabParameterFactory;
import net.sf.jasperreports6.crosstabs.xml.JRCrosstabRowGroupFactory;
...
import net.sf.jasperreports6.engine.TabStop;
import net.sf.jasperreports6.engine.analytics.data.Axis;
import net.sf.jasperreports6.engine.analytics.dataset.BucketOrder;
import net.sf.jasperreports6.engine.analytics.dataset.DesignDataAxis;
import net.sf.jasperreports6.engine.analytics.dataset.DesignDataAxisLevel;
import net.sf.jasperreports6.engine.analytics.dataset.DesignDataLevelBucket;
import net.sf.jasperreports6.engine.analytics.dataset.DesignDataLevelBucketProperty;
import net.sf.jasperreports6.engine.analytics.dataset.DesignDataMeasure;
import net.sf.jasperreports6.engine.analytics.dataset.DesignMultiAxisData;
import net.sf.jasperreports6.engine.analytics.dataset.DesignMultiAxisDataset;
import net.sf.jasperreports6.engine.component.ComponentsBundle;
import net.sf.jasperreports6.engine.component.ComponentsEnvironment;
import net.sf.jasperreports6.engine.component.ComponentsXmlParser;
import net.sf.jasperreports6.engine.component.XmlDigesterConfigurer;
import net.sf.jasperreports6.engine.design.DesignReturnValue;
import net.sf.jasperreports6.engine.design.JRDesignDataset;
import net.sf.jasperreports6.engine.design.JRDesignElement;
import net.sf.jasperreports6.engine.design.JRDesignElementGroup;
import net.sf.jasperreports6.engine.design.JRDesignExpression;
import net.sf.jasperreports6.engine.design.JRDesignGroup;
import net.sf.jasperreports6.engine.design.JRDesignQuery;
import net.sf.jasperreports6.engine.design.JRDesignReportTemplate;
import net.sf.jasperreports6.engine.design.JRDesignVariable;
import net.sf.jasperreports6.engine.design.JasperDesign;
import net.sf.jasperreports6.engine.part.PartComponentsBundle;
import net.sf.jasperreports6.engine.part.PartComponentsEnvironment;
import net.sf.jasperreports6.engine.type.BorderSplitType;
import net.sf.jasperreports6.engine.type.CalculationEnum;
import net.sf.jasperreports6.engine.type.HorizontalPosition;
import net.sf.jasperreports6.engine.type.OverflowType;
import net.sf.jasperreports6.engine.util.CompositeClassloader;
import net.sf.jasperreports6.engine.xml.JRChartFactory.JRCategoryAxisFormatFactory;
...
//		 time series dataset
	...
	private static void addCrosstabRules(Digester digester)
	{
		...
		@SuppressWarnings("deprecation")
		Class<?> depXtabParamValueExprFactory = net.sf.jasperreports6.crosstabs.xml.JRCrosstabParameterValueExpressionFactory.class;
		...
		@SuppressWarnings("deprecation")
		Class<?> depXtabMeasureExprFactory = net.sf.jasperreports6.crosstabs.xml.JRCrosstabMeasureExpressionFactory.class;
