...
public class RenderableUtil
{
	 ...
	 * @deprecated To be removed.
	 */
	public net.sf.jasperreports6.renderers.Renderable getOnErrorRendererForDimension(
		RenderersCache renderersCache,
		net.sf.jasperreports6.renderers.Renderable renderer, 
		OnErrorTypeEnum onErrorType
		) throws JRException
	{
		net.sf.jasperreports6.renderers.Renderable result = null;
		...
		if (dimensionRenderer != null)
		{
			try
			{
				...
				result = (net.sf.jasperreports6.renderers.Renderable)dimensionRenderer;
			}
			catch (Exception e)
			{
				result = handleImageError(e, onErrorType);
	...
	public static Renderable getWrappingRenderable(JRRenderable deprecatedRenderer)
	{
		...
		if (deprecatedRenderer != null)
		{
			...
			if (renderable == null)
			{
				renderable = new net.sf.jasperreports6.engine.util.WrappingRenderable(deprecatedRenderer);
			}
		}
		return renderable;
	}
	...
	public static Renderable getWrappingRenderable(JRImageMapRenderer deprecatedRenderer)
	{
		...
		if (deprecatedRenderer != null)
		{
			...
			if (renderable == null)
			{
				renderable = new net.sf.jasperreports6.engine.util.WrappingImageMapRenderable(deprecatedRenderer);
			}
		}
		return renderable;
	}
	 ...
	 * @deprecated To be removed.
	 */
	public static Renderable getWrappingRenderable(net.sf.jasperreports6.renderers.Renderable renderable)
	{
		...
		if (renderable != null)
		{
			...
			if (deprecatedRenderable == null)
			{
				...
				else
				{
					...
					{
						dataRenderable = (DataRenderable)renderable;
						grxRenderable = new net.sf.jasperreports6.renderers.WrappingDataToGraphics2DRenderer((DataRenderable)renderable);
					}
					else
					{
						throw 
				...
				deprecatedRenderable = 
					new net.sf.jasperreports6.renderers.WrappingDeprecatedRenderable(
						renderable.getId(),
						grxRenderable, 
						dataRenderable, 
						dimensionRenderable
