 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.engine.JRAbstractScriptlet}</li>
 * <li>{@link net.sf.jasperreports6.engine.JRDefaultScriptlet}</li>
 * </ul>
 * Any number of scriptlets can be specified per report. If no scriplet is specified for a 
 * report, the engine still creates a single {@link net.sf.jasperreports6.engine.JRDefaultScriptlet} 
 * instance and registers it with the built-in {@link net.sf.jasperreports6.engine.JRParameter#REPORT_SCRIPTLET REPORT_SCRIPTLET} 
 * parameter. 
 * <p>
 * For each scriplet, a name and a class extending the 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet} class must 
 ...
 * should implement or override, including {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#beforeReportInit() beforeReportInit()}, 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#afterReportInit() afterReportInit()}, 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#beforePageInit() beforePageInit()}, 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#afterPageInit() afterPageInit()}, 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#beforeGroupInit(String)}, and 
 * {@link net.sf.jasperreports6.engine.JRAbstractScriptlet#afterGroupInit(String)}. The report engine calls these methods at the appropriate time when 
 * filling the report. 
 * </p><p> 
 ...
 * {@link net.sf.jasperreports6.engine.scriptlets.ScriptletFactory} interface. 
 * </p><p>
 ...
 * interval. 
 * </p><p>
 * The {@link net.sf.jasperreports6.governors.MaxPagesGovernor} is a global scriptlet 
 ...
 * The {@link net.sf.jasperreports6.governors.TimeoutGovernor} is also a global scriptlet 
 ...
 * 
 * @see net.sf.jasperreports6.engine.JRAbstractScriptlet
 * @see net.sf.jasperreports6.engine.JRDefaultScriptlet
 * @see net.sf.jasperreports6.engine.JRParameter#REPORT_SCRIPTLET
 * @see net.sf.jasperreports6.governors.MaxPagesGovernor
 * @see net.sf.jasperreports6.governors.TimeoutGovernor
 */
package net.sf.jasperreports6.engine.scriptlets;
