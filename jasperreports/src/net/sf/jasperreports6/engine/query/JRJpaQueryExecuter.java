...
import net.sf.jasperreports6.engine.data.JRJpaDataSource;
 ...
 * When running or filling reports the <code>em</code> need to be supplied with the named parameter {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_ENTITY_MANAGER}.
 * <p/>
 * Example:
 * <code>
 * <pre>
 ...
 * </code>
 * <p/>
 * When dealing with large result sets, pagination can be used by setting the {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PROPERTY_JPA_QUERY_PAGE_SIZE} property in the report template.
 * <p/>
 * Example:
 * <code>
 * <pre>
 ...
 * or by supplying the named parameter {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_QUERY_HINTS_MAP}
 ...
 * @see net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory
 */
