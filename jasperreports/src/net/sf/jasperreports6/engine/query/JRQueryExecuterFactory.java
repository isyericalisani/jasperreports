 ...
 * @see net.sf.jasperreports6.engine.query.JRQueryExecuter
...
public interface JRQueryExecuterFactory
{
	 ...
	 * @throws JRException
	 * @deprecated Replaced by {@link QueryExecuterFactory#createQueryExecuter(net.sf.jasperreports6.engine.JasperReportsContext, JRDataset, Map)}.
	 */
