 ...
 * {@link net.sf.jasperreports6.engine.JRDataSource} object as the report data source, but 
 ...
 * {@link net.sf.jasperreports6.engine.JRDataSource} object when filling the report. 
 * </p><p>
 ...
 * {@link net.sf.jasperreports6.engine.design.JRDesignQuery#setLanguage(String) setLanguage(String)}. The default language is SQL, thus ensuring 
 ...
 * {@link net.sf.jasperreports6.engine.query.QueryExecuterFactory#QUERY_EXECUTER_FACTORY_PREFIX net.sf.jasperreports.query.executer.factory.&lt;language&gt;}. The same mechanism can be used to 
 ...
 * interface, implementations of these interfaces, and {@link net.sf.jasperreports6.engine.JRDataSource} implementations. 
 * </p><p>
 * {@link net.sf.jasperreports6.engine.query.QueryExecuterFactory} is a factory interface used to query executers for a specific 
 ...
 * </ul>
 * A {@link net.sf.jasperreports6.engine.query.JRQueryExecuter} is responsible for running a query, creating a 
 ...
 * {@link net.sf.jasperreports6.engine.query.JRAbstractQueryExecuter} as 
 * a base. The abstract base provides query parameter processing functionality and other 
 * utility methods. 
 * </p><p>
 * In most cases, a query executer needs a new {@link net.sf.jasperreports6.engine.JRDataSource} 
 * implementation to wrap its specific query results. Still, in some of the cases, query executers 
 * can use existing {@link net.sf.jasperreports6.engine.JRDataSource} implementations.  
 * </p><p>
 ...
 * {@link net.sf.jasperreports6.engine.query.QueryExecuterFactoryBundle} interface. 
 * </p>
 ...
 * {@link net.sf.jasperreports6.engine.JRParameter#REPORT_CONNECTION REPORT_CONNECTION} parameter 
 ...
 * The query executer creates a {@link net.sf.jasperreports6.engine.JRResultSetDataSource} data source to wrap the JDBC 
 * result set. 
 * </p><p>
 * Aborting the currently running query is supported using 
 * <code>java.sql.PreparedStatement.cancel()</code> when running a report asynchronously by using {@link net.sf.jasperreports6.engine.fill.FillHandle#cancellFill()}.
 ...
 * {@link net.sf.jasperreports6.engine.query.JRJdbcQueryExecuterFactory#PROPERTY_JDBC_QUERY_TIMEOUT net.sf.jasperreports.jdbc.query.timeout} configuration property
 ...
 * {@link net.sf.jasperreports6.engine.query.JRJdbcQueryExecuterFactory#PROPERTY_JDBC_FETCH_SIZE net.sf.jasperreports.jdbc.fetch.size} configuration property at report level or 
 * globally.
 * </p>
 ...
 * {@link net.sf.jasperreports6.engine.query.JRXPathQueryExecuterFactory#PARAMETER_XML_DATA_DOCUMENT XML_DATA_DOCUMENT} 
 * of type <code>org.w3c.dom.Document</code>. The query executer will run the XPath query against this 
 * document and produce a {@link net.sf.jasperreports6.engine.data.JRXmlDataSource} data source. 
 * </p><p>
 ...
 * purposes when creating the {@link net.sf.jasperreports6.engine.data.JRXmlDataSource} instance: 
 * <ul>
 * <li>{@link net.sf.jasperreports6.engine.query.JRXPathQueryExecuterFactory#XML_LOCALE XML_LOCALE}</li>
 * <li>{@link net.sf.jasperreports6.engine.query.JRXPathQueryExecuterFactory#XML_NUMBER_PATTERN XML_NUMBER_PATTERN}</li>
 * <li>{@link net.sf.jasperreports6.engine.query.JRXPathQueryExecuterFactory#XML_DATE_PATTERN XML_DATE_PATTERN}</li>
 * </ul>
 * </p>
 ...
 * parameter named {@link net.sf.jasperreports6.engine.query.JRHibernateQueryExecuterFactory#PARAMETER_HIBERNATE_SESSION HIBERNATE_SESSION} 
 ...
 * {@link net.sf.jasperreports6.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_QUERY_RUN_TYPE net.sf.jasperreports.hql.query.run.type}. The run type can be one of the following: 
 * <ul>
 ...
 * the {@link net.sf.jasperreports6.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_QUERY_LIST_PAGE_SIZE net.sf.jasperreports.hql.query.list.page.size} 
 ...
 * This is why the {@link net.sf.jasperreports6.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_CLEAR_CACHE net.sf.jasperreports.hql.clear.cache} property was introduced. 
 ...
 * {@link net.sf.jasperreports6.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_FIELD_MAPPING_DESCRIPTIONS net.sf.jasperreports.hql.field.mapping.descriptions} configuration 
 ...
 * {@link net.sf.jasperreports6.olap.JRMondrianQueryExecuterFactory#PARAMETER_MONDRIAN_CONNECTION MONDRIAN_CONNECTION} 
 ...
 * </p><p>
 * The Mondrian query executer passes the query result to a {@link net.sf.jasperreports6.olap.JRMondrianDataSource}, which 
 ...
 * {@link net.sf.jasperreports6.olap.JRMdxQueryExecuterFactory} class that is registered by default 
 ...
 * the {@link net.sf.jasperreports6.olap.JRMondrianQueryExecuterFactory} or the 
 * {@link net.sf.jasperreports6.olap.xmla.JRXmlaQueryExecuterFactory}, 
 ...
 * then checks for the {@link net.sf.jasperreports6.olap.xmla.JRXmlaQueryExecuterFactory#PARAMETER_XMLA_URL PARAMETER_XMLA_URL} 
 ...
 * {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_ENTITY_MANAGER JPA_ENTITY_MANAGER} 
 * built-in parameter: 
 * <pre>
 ...
 * {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_QUERY_HINTS_MAP JPA_QUERY_HINTS_MAP} 
 ...
 * {@link net.sf.jasperreports6.engine.query.JRJpaQueryExecuterFactory#PROPERTY_JPA_QUERY_HINT_PREFIX net.sf.jasperreports.ejbql.query.hint.&lt;hintName&gt;} as a hint by interpreting 
 ...
 * {@link net.sf.jasperreports6.engine.data.JRJpaDataSource} 
 ...
 * @see net.sf.jasperreports6.engine.JRDataSource
 * @see net.sf.jasperreports6.engine.JRResultSetDataSource
 * @see net.sf.jasperreports6.engine.data.JRJpaDataSource
 * @see net.sf.jasperreports6.engine.data.JRXmlDataSource
 * @see net.sf.jasperreports6.olap.JRMdxQueryExecuterFactory
 * @see net.sf.jasperreports6.olap.JRMondrianDataSource
 * @see net.sf.jasperreports6.olap.JRMondrianQueryExecuterFactory
 * @see net.sf.jasperreports6.olap.xmla.JRXmlaQueryExecuterFactory
 */
