...
import net.sf.jasperreports6.data.RewindableDataSourceProvider;
...
import net.sf.jasperreports6.engine.data.JsonData;
import net.sf.jasperreports6.engine.data.JsonDataCollection;
import net.sf.jasperreports6.engine.data.TextDataSourceAttributes;
