 ...
 * can be passed to the dataset instead of a {@link net.sf.jasperreports6.engine.JRDataSource} instance, 
 ...
 * used.
 * 
 * @see net.sf.jasperreports6.engine.JRDataset
 * @see net.sf.jasperreports6.engine.JRChartDataset#getDatasetRun()
