 ...
 * <ul>
 * <li>a {@link net.sf.jasperreports6.engine.JRPen} element that can be retrieved 
 * using the {@link #getLinePen()} method.</li>
 * <li>a {@link net.sf.jasperreports6.engine.JRLineBox} element that can be retrieved 
 * using the {@link #getLineBox()} method.</li>
 * <li>a {@link net.sf.jasperreports6.engine.JRParagraph} element that can be retrieved 
 * using the {@link #getParagraph()} method inherited from the 
 *  {@link net.sf.jasperreports6.engine.JRParagraphContainer} interface.</li>
 * </ul>
 * <p>
 ...
 * </p>
 * @see net.sf.jasperreports6.engine.JRLineBox
 * @see net.sf.jasperreports6.engine.JRParagraph
 * @see net.sf.jasperreports6.engine.JRPen
