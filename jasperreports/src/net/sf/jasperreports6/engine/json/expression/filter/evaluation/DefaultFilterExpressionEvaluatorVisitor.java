...
import net.sf.jasperreports6.engine.json.expression.filter.CompoundFilterExpression;
import net.sf.jasperreports6.engine.json.expression.filter.NotFilterExpression;
