...
import net.sf.jasperreports6.engine.base.StandardPrintParts;
...
public class JasperPrint implements Serializable, JRPropertiesHolder, JRChangeEventsSupport
{
	...
	/**
	 * Returns the name of the class implementing the {@link net.sf.jasperreports6.engine.util.FormatFactory FormatFactory}
	...
	/**
	 * Sets the name of the class implementing the {@link net.sf.jasperreports6.engine.util.FormatFactory FormatFactory}
	 * interface to use with this document.
	 */
