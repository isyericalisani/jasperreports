 ...
 * {@link net.sf.jasperreports6.engine.design.JasperDesign} objects into
 * {@link net.sf.jasperreports6.engine.JasperReport} objects. Both classes are
 * implementations of the same basic {@link net.sf.jasperreports6.engine.JRReport}
 * interface. However, {@link net.sf.jasperreports6.engine.JasperReport} objects 
 * cannot be modified once they are produced,
 * while {@link net.sf.jasperreports6.engine.design.JasperDesign} objects can. 
 ...
 * updated.
 * </p><p>
 * {@link net.sf.jasperreports6.engine.design.JasperDesign} objects are produced when parsing JRXML files using the
 * {@link net.sf.jasperreports6.engine.xml.JRXmlLoader} or created directly by the parent
 ...
 * </p><p>
 * A {@link net.sf.jasperreports6.engine.design.JasperDesign} object must be 
 * subject to the report compilation process to produce a
 * {@link net.sf.jasperreports6.engine.JasperReport} object.
 * </p><p>
 * Central to this process is this {@link net.sf.jasperreports6.engine.design.JRCompiler}
 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.compilers.JRGroovyCompiler}</li>
 * <li>{@link net.sf.jasperreports6.compilers.JavaScriptCompiler}</li>
 * </ul>
 * <p>
 ...
 * and store bytecode in the generated {@link net.sf.jasperreports6.engine.JasperReport}
 ...
 * <ul>
 * <li>{@link net.sf.jasperreports6.engine.design.JRJdtCompiler}</li>
 * <li>{@link net.sf.jasperreports6.engine.design.JRJdk13Compiler}</li>
 * <li>{@link net.sf.jasperreports6.engine.design.JRJavacCompiler}</li>
 * </ul>
...
public interface JRCompiler
{
	 ...
	 * No default value.
	 * 
	 * @deprecated Replaced by {@link net.sf.jasperreports6.engine.design.JRCompiler#COMPILER_PREFIX}.
	 */
