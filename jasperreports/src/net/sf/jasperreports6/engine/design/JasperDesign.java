...
import net.sf.jasperreports6.engine.base.JRBaseReport;
import net.sf.jasperreports6.engine.design.events.PropagationChangeListener;
...
import net.sf.jasperreports6.engine.util.JRElementsVisitor;
import net.sf.jasperreports6.engine.util.JRVisitorSupport;
 ...
 * {@link net.sf.jasperreports6.engine.JRReport} interface
 ...
 * with the {@link net.sf.jasperreports6.engine.JasperCompileManager} in order to prepare them
 ...
 * </p>
 *
 * @see net.sf.jasperreports6.engine.JRReport
 * @see net.sf.jasperreports6.engine.base.JRBaseReport
...
public class JasperDesign extends JRBaseReport
{
	 ...
	 * @see net.sf.jasperreports6.engine.type.PrintOrderEnum VERTICAL,
	 * @see net.sf.jasperreports6.engine.type.PrintOrderEnum HORIZONTAL
	 */
	 ...
	 * @see net.sf.jasperreports6.engine.JRReport ORIENTATION_PORTRAIT,
	 * @see net.sf.jasperreports6.engine.JRReport ORIENTATION_LANDSCAPE
	 */
	 ...
	 * @see net.sf.jasperreports6.engine.JRReport#isIgnorePagination()
	 */
