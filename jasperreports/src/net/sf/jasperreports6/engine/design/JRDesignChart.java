...
import net.sf.jasperreports6.charts.design.JRDesignAreaPlot;
import net.sf.jasperreports6.charts.design.JRDesignBar3DPlot;
import net.sf.jasperreports6.charts.design.JRDesignBarPlot;
import net.sf.jasperreports6.charts.design.JRDesignBubblePlot;
import net.sf.jasperreports6.charts.design.JRDesignCandlestickPlot;
import net.sf.jasperreports6.charts.design.JRDesignCategoryDataset;
import net.sf.jasperreports6.charts.design.JRDesignGanttDataset;
import net.sf.jasperreports6.charts.design.JRDesignHighLowDataset;
import net.sf.jasperreports6.charts.design.JRDesignHighLowPlot;
import net.sf.jasperreports6.charts.design.JRDesignLinePlot;
import net.sf.jasperreports6.charts.design.JRDesignMeterPlot;
import net.sf.jasperreports6.charts.design.JRDesignMultiAxisPlot;
import net.sf.jasperreports6.charts.design.JRDesignPie3DPlot;
import net.sf.jasperreports6.charts.design.JRDesignPieDataset;
import net.sf.jasperreports6.charts.design.JRDesignPiePlot;
import net.sf.jasperreports6.charts.design.JRDesignScatterPlot;
import net.sf.jasperreports6.charts.design.JRDesignThermometerPlot;
...
import net.sf.jasperreports6.charts.design.JRDesignValueDataset;
import net.sf.jasperreports6.charts.design.JRDesignXyDataset;
import net.sf.jasperreports6.charts.design.JRDesignXyzDataset;
...
public class JRDesignChart extends JRDesignElement implements JRChart
{
	 ...
	 * @see net.sf.jasperreports6.engine.JRChartCustomizer
 	 */
