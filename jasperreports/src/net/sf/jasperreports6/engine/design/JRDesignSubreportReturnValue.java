...
import net.sf.jasperreports6.engine.base.JRBaseSubreportReturnValue;
...
/**
 * Implementation of {@link net.sf.jasperreports6.engine.JRSubreportReturnValue JRSubreportReturnValue}
...
public class JRDesignSubreportReturnValue extends JRBaseSubreportReturnValue implements JRChangeEventsSupport // do not extend DesignCommonReturnValue to avoid deserialization field issues
{
	 ...
	 * @see net.sf.jasperreports6.engine.JRSubreportReturnValue#getFromVariable()
	 */
	 ...
	 * 
	 * @param name the variable name
	 * @see net.sf.jasperreports6.engine.JRSubreportReturnValue#getToVariable()
	 */
	 ...
	 * @see net.sf.jasperreports6.engine.JRSubreportReturnValue#getCalculation()
	 */
	 ...
	 * @see net.sf.jasperreports6.engine.JRSubreportReturnValue#getIncrementerFactoryClassName()
	 */
