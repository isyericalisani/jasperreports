 ...
 */
package net.sf.jasperreports6.renderers.util;
...
import net.sf.jasperreports6.renderers.util.SvgDataSniffer.SvgInfo;
import net.sf.jasperreports6.renderers.util.XmlDataSniffer.XmlSniffResult;
...
public class RendererUtil
{
	...
	public static boolean isLazy(Renderable renderer)
	{
		...
		else if (renderer != null)
		{
			...
			Class<?> depClass = net.sf.jasperreports6.engine.JRImageRenderer.class;
			if (depClass.equals(renderer.getClass()))
			{
				@SuppressWarnings("deprecation")
				net.sf.jasperreports6.engine.JRImageRenderer depRenderer = (net.sf.jasperreports6.engine.JRImageRenderer)renderer;
				@SuppressWarnings("deprecation")
