...
public class WrappingDataToGraphics2DRenderer extends AbstractRenderToImageAwareRenderer implements DataRenderable, Graphics2DRenderable, DimensionRenderable, AreaHyperlinksRenderable
{
	...
	private byte[] data;
	private net.sf.jasperreports6.engine.type.RenderableTypeEnum renderableType;
	...
	public net.sf.jasperreports6.engine.type.RenderableTypeEnum getRenderableType()
	{
		try
		{
		...
		{
			//ignore
			return net.sf.jasperreports6.engine.type.RenderableTypeEnum.IMAGE; // arbitrary default; should not get here in normal cases
		}
	...
	protected void updateCache(JasperReportsContext jasperReportsContext) throws JRException
	{
			...
			)
		{
			...
			if (isSvgData)
			{
				...
				renderableType = net.sf.jasperreports6.engine.type.RenderableTypeEnum.SVG;
			}
			else
			{
				grxRenderer = new WrappingImageDataToGraphics2DRenderer(dataRenderer);
				renderableType = net.sf.jasperreports6.engine.type.RenderableTypeEnum.IMAGE;
			}
