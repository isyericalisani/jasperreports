 ...
 */
package net.sf.jasperreports6.web.servlets;
...
public interface JasperPrintAccessor
{
	...
	public static final String REPORT_CONTEXT_PARAMETER_JASPER_PRINT_ACCESSOR = "net.sf.jasperreports6.web.jasper_print.accessor";
